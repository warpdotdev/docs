...
There's currently no way to navigate between different UI elements using VO key combinations.

Once installed, it will ask you to log in using your GitHub credentials. 
...
As you may notice, typical Voice Over navigation keys or settings do not currently work in Warp. 
In short - it's related to how our UI Framework is currently implemented and that as of now we don't yet offer a keyboard accessible way to navigate the UI elements.
...
Some a11y-specific settings are available through the command palette.
For example, you can adjust the verbosity level of messages.
Simply enter the command palette (cmd-p) and type "a11y" to discover related options and their keybindings.
