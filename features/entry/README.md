...
1. [Workflows](workflows.md) (`CTRL-SHIFT-R`) are an easier way to execute and share parameterized and searchable commands within Warp.
...
4. [Synchronized Inputs](synchronized-inputs.md) (`OPT-CMD-I`) allows you to easily run the same command in multiple sessions at the same time.
