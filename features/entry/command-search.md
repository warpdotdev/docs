...
![Command Search](../.gitbook/assets/command-search.png)
...
1. Or if you want to activate a specific filter, you can prepend your search term with: 
    ...
    * `#:` will activate the A.I. Command Search filter. 
    Once the filter is activated, it will be bolded and italicized.
1. Once the result shows up, press ENTER to input the generated command directly into Warp's Input Editor. For history results specifically, pressing `CMD-ENTER` will directly execute the command.

## How it works

{% embed url="https://www.loom.com/share/21a6f58a33754ee7913edbff6d33d8d1 ?hide_owner=true&hide_share=true&hide_title=true&hideEmbedTopBar=true" %}Command Search Demo{% endembed %}
