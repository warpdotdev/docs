...
The Command Search panel allows you to search across Command History, Workflows, Notebooks (**Coming Soon**), and A.I. Command Suggestions all at once. Warp supports fuzzy search and tries to rank more relevant search queries.
