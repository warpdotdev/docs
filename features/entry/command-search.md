...
* Type into the input box what your search query is. The results will be a mix of command history, saved workflows, and A.I. Command Suggestions.
  ...
  * <img src="../../.gitbook/assets/ai-sparkle.png" alt="sparkle" data-size="line"> Sparkle icon signifies piping that search query into [A.I. Command Suggestions ](../warp-ai/ai-command-suggestions.md)
