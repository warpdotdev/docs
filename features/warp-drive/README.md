...
<figure><img src="../../docs/.gitbook/assets/Open_Warp_Drive.png" alt="Warp Drive icon on top left corner of Warp"><figcaption><p>Warp Drive Icon</p></figcaption></figure>
...
<figure><img src="../../docs/.gitbook/assets/Warp_Drive_Zero_State.png" alt=""><figcaption></figcaption></figure>

If you are a member of a team using Warp Drive, your team’s workspace will also be available in the side panel.

<figure><img src="../../docs/.gitbook/assets/Warp_Drive_with_Team.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../docs/.gitbook/assets/warp_drive_offline.png" alt=""><figcaption><p>Warp Drive offline mode</p></figcaption></figure>
...
* Press `CMD-SHIFT-(` and `CMD-SHIFT-)` to switch focus on Warp Drive and [Warp AI](../../docs/features/warp-ai/).
...
* Press `CTRL-SHIFT-(` and `CTRL-SHIFT-)` to switch focus on Warp Drive and [Warp AI](../../docs/features/warp-ai/).
{% endtab %}
{% endtabs %}

<figure><img src="../../docs/.gitbook/assets/warp_drive_nav1.png" alt=""><figcaption><p>Warp Drive navigation states</p></figcaption></figure>

To switch between panels (e.g. jump from command line to Warp Drive to Warp AI) using your keyboard, you can use the “Switch Focus to Left Panel” and “Switch Focus to Right Panel” commands in the [Command Palette](../../docs/features/command-palette.md).

<figure><img src="../../docs/.gitbook/assets/warp_drive_nav2.png" alt=""><figcaption></figcaption></figure>
...
* To export all Warp Drive objects, Open the [Command Palette](../../docs/features/command-palette.md#how-to-access-it), search for and select "Export all Warp Drive Objects", then select a directory for export.
...
* [Workflows](../../docs/features/warp-drive/workflows.md) import from and export to YAML
* [Notebooks](../../docs/features/warp-drive/notebooks.md) import from and export to Markdown
