...
If you initiate a shared session using Block actions, you will be given the option to start sharing from the selected block onwards. This option gives you precision to select a specific block of output in your session history as the starting point, excluding all previous scrollback before that block.
...
When you’re ready to end a shared session, you can click Share → Stop sharing to wrap up and close access for all collaborators.&#x20;



#### Multiple shared sessions

You may share multiple sessions simultaneously. If you have multiple shared sessions, you will find _Other shared sessions_ listed in the Share dropdown menu. You may also wrap multiple shared sessions at the same time with Share → Stop sharing all.
