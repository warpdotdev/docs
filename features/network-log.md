...
1. There are 2 main ways to access the network panel.
    ...
    1. Option 2: Press CMD-R > Type in “Tail Warp Network Log”
1. Both options insert a workflow into your input editor - it should look something like this: `tail -f "/Users/warp/Library/Application Support/dev.warp.Warp-Dev/warp_network.log”`
1. Press Enter to run this workflow.
1. Press CMD-D to open up a split pane on the right, then run A.I. Command Search or share a block to see the network log activity.
    1. Example #1: Press CTRL-` to open up A.I. Command Search > Type in “print hello world”
    1. Example #2: Run `echo “hello world”` > Right click on the block > Click “Create permalink” > Click “Create and Copy Link”
1. Once you run one of these examples, you’ll see the corresponding requests and responses logged in the left pane.
