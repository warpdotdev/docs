...
{% hint style="info" %}
**Terminal Tip**\
You can change the Tab names (either rename the tab with something constant, by right clicking the tab; or changing the whole "template" using your .bashrc or .zshrc by adding something like:
