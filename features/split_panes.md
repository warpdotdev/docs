...
The shortcuts `CMD+e` and `CMD+SHIFT+E` divide an existing session vertically or horizontally, respectively.
You can navigate among split panes with `CMD+OPT+ARROW`.
