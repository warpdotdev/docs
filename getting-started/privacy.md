...
* View a list of [all the telemetry events](/getting-started/privacy.md#exhaustive-telemetry-table) that get sent 
* Monitor telemetry in real-time with our native [Network Log](/features/network-log.md)
* [Opt-out](/getting-started/privacy.md#how-to-disable-telemetry) of telemetry at any time
...
![opt-out modal](../.gitbook/assets/opt-out-signup-modal.png)
...
![privacy settings](../.gitbook/assets/privacy-telem-opt-out.png)
...
| `Command Search Opened` |	opened command search (universal search panel to search |history, workflows, AI command search, etc.) |
