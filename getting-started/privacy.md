...
| `Get Invite`                                               | "Get Invite" is clicked                                                                                                 |
| `Get Referral Status`                                      | "Get Referral Status" is clicked                                                                                        |
...
| `Key Binding Changed`                                      | Edited a custom keybinding                                                                                              |
| `Key Binding Reset to Default`                             | Reset a custom keybinding to its default                                                                                |
