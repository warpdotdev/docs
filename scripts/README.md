...
Test the documentation locally by [installing honkit from npm.](https://github.com/honkit/honkit#installation)
...
In order to run the scripts for updating the open source licenses, please checkoout the [licenses_docs section](https://github.com/warpdotdev/developer-experience/tree/main/src/licenses_docs) of the developer-experience repository.
