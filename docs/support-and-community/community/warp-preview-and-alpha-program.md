...
2. **Sign in**: [Log in](https://docs.warp.dev/getting-started/quickstart/installation-and-setup#log-in-to-warp-optional) with your Warp account (not optional for Warp Preview).
...
Share feedback, report bugs, and discuss Preview features in the [community Slack](https://go.warp.dev/join-preview). You can also [send feedback directly from the app](../troubleshooting-and-support/sending-us-feedback.md#sending-warp-feedback).
