...
The fastest way to file a bug or feature request is the [`/feedback`](../troubleshooting-and-support/sending-us-feedback.md#using-feedback-in-warp) slash command inside Warp. It drafts and files a GitHub issue without leaving the terminal.
...
For logs, crash reports, CPU samples, and AI debugging IDs, see [Sending feedback and logs](../troubleshooting-and-support/sending-us-feedback.md).
