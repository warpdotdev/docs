...
1. [Launch Configurations](../../../features/sessions/launch-configurations.md) supports saving a configuration of windows, tabs, and panes to open later.
2. [Session Navigation](../../../features/sessions/session-navigation.md) enables you to easily navigate to any session in Warp.
