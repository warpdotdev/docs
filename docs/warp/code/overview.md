...
* [Codebase Context](https://docs.warp.dev/agent-platform/capabilities/codebase-context) for accurate, context-aware agent responses
* [Project Rules](https://docs.warp.dev/agent-platform/capabilities/rules) and Commands to tailor agent behavior per repository
...
* [Code Diffs](https://docs.warp.dev/agent-platform/local-agents/code-diffs) - Learn how to review, refine, and apply code changes generated by Warp's agents using the built-in visual diff editor.
