...
* **Codebase Context** — Each worktree is indexed independently for [Codebase Context](https://docs.warp.dev/agent-platform/capabilities/codebase-context), so Agents have accurate context for whichever worktree you're working in.
