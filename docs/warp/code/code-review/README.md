...
{% hint style="info" %}
To review agent-generated diffs, leave inline comments, batch your feedback, and have the agent apply all requested changes, see [Interactive Code Review](interactive-code-review.md).
{% endhint %}
...
<figure><img src="../../.gitbook/assets/warp-tab-bar-review-code.png" alt=""><figcaption></figcaption></figure>
...
In addition to reviewing and editing diffs directly in the Code Review pane, you can open a file directly in Warp's [Code Editor](../code-editor/). Each file listed in the Code Review pane includes an expand button in the top-right corner of its diff view.
