...
* [Code Diffs in Agent Conversations](https://docs.warp.dev/agent-platform/local-agents/code-diffs-in-agent-conversations) - Learn how to review, refine, and apply code changes generated by Warp's agents using the built-in visual diff editor.
