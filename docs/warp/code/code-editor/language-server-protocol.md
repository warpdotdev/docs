...
LSP features stay in sync across [shared buffers](README.md#shared-buffers) — if the same file is open in multiple tabs or panes, diagnostics, hover, and other features reflect the same content regardless of which view you're looking at.
