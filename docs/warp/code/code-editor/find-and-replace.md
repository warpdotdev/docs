...
<figure><img src="../../.gitbook/assets/code-find-menu.gif" alt="using find in the code editor"><figcaption><p>Using the find menu in Warp's Code Editor</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/code-replace-menu.gif" alt="using replace in the code editor"><figcaption><p>Using the replace menu in Warp's Code Editor</p></figcaption></figure>
