...
* [**Platform**](https://docs.warp.dev/platform): The underlying infrastructure that powers Ambient Agents and integrations, including the CLI, Agent API/SDK, orchestration layer, environments/execution, secrets, and management/observability.
