...
{% hint style="danger" %}
You can continue to use YAML-based workflows, but we recommend using new [workflows in Warp Drive](../../knowledge-and-collaboration/warp-drive/workflows.md) instead for a better editing experience.
{% endhint %}
