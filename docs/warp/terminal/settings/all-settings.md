...
This page lists every setting you can configure in [`settings.toml`](./) organized by TOML section. For an introduction to the settings file, how to open it, and common configuration examples, see [Settings file](./).
