...
* Right-clicking on a Tab reveals more options you can explore within the [Command Palette](../command-palette.md) or [Keyboard Shortcuts](../../getting-started/keyboard-shortcuts.md#fundamentals).
{% endtab %}
