---
description: >-
  The vertical tabs panel replaces the horizontal tab bar with a sidebar that
  shows rich metadata, drag-and-drop management, and configurable display
  options for every tab and pane.
---
...
* **Worktree** - The active [Git worktree](../../code/git-worktrees.md) path, if applicable.
...
All existing tab keyboard shortcuts continue to work with vertical tabs. The sidebar layout changes how tabs are displayed, not how you interact with them. See [Terminal tabs](tabs.md) for the full list of tab shortcuts.
