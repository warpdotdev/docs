...
Voice input can be enabled in **Settings** > **AI** > **Voice**. For detailed information about voice features and setup, see our [Voice documentation](https://docs.warp.dev/agent-platform/warp-agents/interacting-with-agents/voice).
