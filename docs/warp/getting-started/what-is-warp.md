...
{% hint style="info" %}
Warp's AI experience is now powered by Oz. For the latest on how agents work in Warp, see [Agents in Warp](https://docs.warp.dev/agent-platform/warp-agents).
{% endhint %}

Key Features:

* [**Oz**](https://docs.warp.dev/agent-platform/warp-agents): Warp autodetects whether you are typing a natural language prompt or a command. Use natural language prompts to have an Oz agent write code, debug issues, or write commands for you.
...
{% embed url="https://www.loom.com/share/b8deda329ac847d1be41ec9b8fc522ca" %}
Warp Demo April 2025
{% endembed %}
