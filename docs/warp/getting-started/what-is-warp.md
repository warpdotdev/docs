...
* [**Warp AI**](https://docs.warp.dev/agent-platform/agent/agents-overview): Warp autodetects whether you are typing a natural language prompt or a command. Use natural language prompts to have Warp write code, debug issues, or write commands for you.
* [**Multi-agent management**](https://docs.warp.dev/agent-platform/agent/using-agents/managing-agents): Warp is designed to have multiple agents running at once. Agents will send you notifications if they require your input, and you can see all your agents in one panel.
