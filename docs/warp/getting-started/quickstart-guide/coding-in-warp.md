...
* [Blocks](../../agents/using-agents/agent-context#attaching-blocks-as-context) from your terminal output
* [Images](../../agents/using-agents/agent-context#attaching-images-as-context)
* [Files and code](../../agents/using-agents/agent-context#referencing-files-and-code-using) (using the @ symbol)
* [Public websites](../../agents/using-agents/agent-context#referencing-websites-via-urls) via URLs
