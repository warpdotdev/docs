---
description: >-
  Get started with Warp, the Agentic Development Environment, and Oz,
...
* [**Modern terminal UX**](../terminal/editor/README.md): Cursor movement, block-based navigation, multi-line editing, syntax highlighting, and rich completions. Built with Rust for high performance.
