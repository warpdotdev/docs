...
1. To access the network log, select the Input in a session and open the [Command Palette](../terminal/command-palette.md), then search for “Show Warp Network Log”.
