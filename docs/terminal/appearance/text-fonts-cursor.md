...
* Toggle the Blinking cursor or from the [Command Palette](../command-palette.md), type "Cursor blink" and toggle the setting.

{% hint style="info" %}
Cursor type preference is disabled while [Vim keybindings](../editor/vim.md) (vim mode) is active.
{% endhint %}
