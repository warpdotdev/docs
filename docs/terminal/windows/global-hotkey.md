...
{% tab title="Windows" %}
On Windows, there are no known issues with Global Hotkey Dedicated Window. If you find an issue, please [send feedback](../../support-and-billing/sending-us-feedback.md) to let us know.
{% endtab %}
