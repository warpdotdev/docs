...
When you’re in Agent Mode, the **Agent icon** will be highlighted in the [.](./ "mention").
...
You can add images using the image upload button in the toolbelt (located at the bottom left or right, depending on your input layout). For additional methods of attaching images, see [images-as-context.md](../../agents/using-agents/agent-context/images-as-context.md "mention").
...
For a full list of supported models and guidance on when to use them, see [model-choice.md](../../agents/using-agents/model-choice.md "mention").
