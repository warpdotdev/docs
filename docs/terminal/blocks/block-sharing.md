...
{% hint style="info" %}
If you experience any issues with block sharing, please see our known issues for [troubleshooting steps](../../support-and-billing/known-issues.md#online-features-dont-work).
{% endhint %}
