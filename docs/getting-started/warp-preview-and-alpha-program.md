---
description: >
  Warp Preview is an early-access build of Warp with experimental features. The Alpha Program offers the most engaged users unlimited AI.
---
...
2. Sign in: [Log in](../README.md#log-in-to-warp-optional) with your Warp account (not optional for Warp Preview).
...
For details on how to send feedback for Warp Preview, please see [Preview-Specific Feedback](../help/sending-us-feedback.md#preview-specific-feedback).
