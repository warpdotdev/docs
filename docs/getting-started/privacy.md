...
| `Citations Shown in Agent Mode` | Agent mode used and cited external sources that were used in its response |
...
| `Failed to deserialize GenerateAIAgentOutput response` | Failed to deserialize GenerateAIAgentOutput response |
...
| `Opened Agent Mode Citation` | Opened a citation that was surfaced in agent mode |
...
| `Team Onboarding Block Shown` | Showed team onboarding block to new users |
