---
description: Learn how to import settings from other terminals when you switch to Warp.
---
...
<figure><img src="broken-reference" alt=""><figcaption><p>Select a settings profile to import</p></figcaption></figure>
