...
* [Slack and Linear integrations](../platform/cli/integrations-and-environments.md):\*\* Ask the agent to get to work from the tools you already use, track their progress, and take the wheel via live session sharing.
