...
For installation, authentication, project configuration, and productivity tips, see the [How to set up Codex CLI](https://docs.warp.dev/guides/integrations/how-to-set-up-codex-cli) guide.
