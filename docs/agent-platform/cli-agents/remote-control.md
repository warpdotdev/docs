...
{% hint style="info" %}
Remote Control is built on top of [Agent Session Sharing](../warp-agents/session-sharing.md). It uses the same underlying infrastructure to publish sessions and generate shareable links.
{% endhint %}
...
Remote Control differs from standard [Agent Session Sharing](../warp-agents/session-sharing.md) in its intent: Session Sharing is designed for live collaborative work (pair-programming, interactive debugging), while Remote Control is designed for async monitoring and steering when you're away from your machine.
...
* [Agent Session Sharing](../warp-agents/session-sharing.md)
* [Third-Party CLI Agents](overview.md)
