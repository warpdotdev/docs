...
* From [Slack](https://docs.warp.dev/agent-platform/cloud-agents/integrations/slack), click **View Agent** in the agent response to open the session.
* From [Linear](https://docs.warp.dev/agent-platform/cloud-agents/integrations/linear), click the ↗ **Warp** button ("Open in Warp") on the ticket to open the session.
