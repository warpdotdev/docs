...
Ambient Agents and [integrations](../integrations/integrations-overview.md) run on the [Warp Platform](../platform/warp-platform.md) control plane, and usage is billed using credits.
