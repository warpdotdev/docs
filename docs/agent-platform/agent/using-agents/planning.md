...
You can generate a plan using the `/plan` [slash command](../slash-commands.md) or by asking the agent in natural language in the [Universal Input](https://docs.warp.dev/terminal/universal-input/).
