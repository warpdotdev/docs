...
When you start an [Agent conversation](using-agents/agent-conversations/), the Agent receives a list of all available skills with their names and descriptions. This allows the Agent to understand what skills exist without loading their full content into context.
