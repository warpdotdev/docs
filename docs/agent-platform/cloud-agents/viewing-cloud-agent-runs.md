...
When a cloud agent starts working — for example, from a Slack mention, a Linear issue, or a [CLI](https://docs.warp.dev/reference/cli) trigger — Warp attaches a shareable link to the run.

* From [Slack](./integrations/slack.md), click **View Agent** in the agent response to open the session.
* From [Linear](./integrations/linear.md), click the ↗ **Warp** button ("Open in Warp") on the ticket to open the session.
