---
description: >-
  Connect Oz cloud agents to Azure DevOps repos using personal access tokens and
...
* **Slack** — Tag **@Oz** in a message to start an agent run against your Azure DevOps repo. See [Slack](slack.md).
