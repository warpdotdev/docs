...
* **Secrets**: For credentials and sensitive data, use [Agent Secrets](../ambient-agents/agent-secrets.md). These are configured separately from environments and injected securely at runtime.
{% endhint %}
