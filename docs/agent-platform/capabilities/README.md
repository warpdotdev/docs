...
* [Slash Commands](slash-commands.md) - Quick actions and saved prompts accessible by typing `/` in Agent Mode.
* [Skills](skills.md) - Reusable, scoped instructions that teach agents how to perform specific tasks in your codebase.
* [Planning](planning.md) - Turn agent requests into organized, editable plans that execute step-by-step with full visibility.
