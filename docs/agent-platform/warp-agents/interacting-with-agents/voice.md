...
{% hint style="info" %}
Voice input functionality can be configured in **Settings** > **Agents** > **Oz** > **Voice**. You can toggle voice input and select your preferred activation hotkey from pre-defined options.
{% endhint %}
