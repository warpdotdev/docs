...
<figure><img src="../../documentation/.gitbook/assets/linear-warp-on-web.png" alt=""><figcaption></figcaption></figure>
...
* The CLI
* The guided flow using `/create-environment` ([Slash Commands](../agents/slash-commands.md))
