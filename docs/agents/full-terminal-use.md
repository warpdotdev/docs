...
{% embed url="https://www.youtube.com/watch?v=LCkoRFX9HfM" %}
...
<figure><img src="../.gitbook/assets/full-terminal-use-takeover.png" alt="" width="310"><figcaption><p>Option to take over from agent in the footer.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/full-terminal-use-handoff.png" alt=""><figcaption><p>Option to hand-off to the agent in the conversation footer.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/allow-refine-takeover.png" alt=""><figcaption><p>Allow, Refine, or Take over an agent response.</p></figcaption></figure>

<figure><img src="../.gitbook/assets/full-terminal-use-options (2).png" alt="" width="375"><figcaption><p>Ability to accept or auto-approve future interactions.</p></figcaption></figure>
...
You can configure global defaults from your [agent-profiles-permissions.md](using-agents/agent-profiles-permissions.md "mention") settings:
...
{% hint style="info" %}
**Note**: All [Secret Redaction](../privacy/secret-redaction.md) features still apply during Full Terminal Use, so sensitive values in your environment or output remain protected.
{% endhint %}

### AI credits usage

All AI interactions from Full Terminal Use consume [ai-credits.md](../support-and-billing/plans-and-pricing/ai-credits.md "mention"), including understanding your natural language requests, planning and generating terminal commands, interpreting and summarizing command output, and iterating on commands in long-running sessions.&#x20;
