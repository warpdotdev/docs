...
* OpenAI: `GPT-5.1`, `GPT-5`&#x20;
  * _Note: GPT-5 mini with minimal reasoning does not support web search_
...
Web search is controlled per [agent-profiles-permissions.md](agent-profiles-permissions.md "mention").
