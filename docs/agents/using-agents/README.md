...
When you’re in Agent Mode, the **Agent icon** will be highlighted in the [universal-input](../../terminal/universal-input/ "mention").
...
For the full list of available models and guidance on when to use each, see [model-choice.md](model-choice.md "mention").
