...
* Built-in [voice.md](../voice.md "mention") transcription.
* An easy way to [images-as-context.md](agent-context/images-as-context.md "mention") to your prompt
* Browse files in the [code-editor](../../code/code-editor/ "mention") and review code changes directly in the [code-review](../../code/code-review/ "mention") panel.
