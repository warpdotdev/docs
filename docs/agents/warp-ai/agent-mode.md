...
For more FAQs about pricing, visit [Plans, Subscriptions, and Pricing](../../support-and-billing/plans-and-pricing.md).
...
Lite is more token-efficient than other premium models and supports core AI workflows. Learn more in [What is Lite?](../../support-and-billing/plans-and-pricing.md#what-is-lite) in our pricing documentation for more details.
