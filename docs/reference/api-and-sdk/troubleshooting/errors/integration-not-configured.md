...
* [Integrations](https://docs.warp.dev/agent-platform/cloud-agents/integrations) — Integration setup guides
* [Slack Integration](https://docs.warp.dev/agent-platform/cloud-agents/integrations/slack) — Slack-specific setup
* [Linear Integration](https://docs.warp.dev/agent-platform/cloud-agents/integrations/linear) — Linear-specific setup
