---
description: >-
  The requested resource (task, environment, schedule, agent, etc.)
...
* [Environments](https://docs.warp.dev/agent-platform/cloud-agents/environments) — Managing cloud agent environments
