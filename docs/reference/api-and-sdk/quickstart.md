---
description: >-
  Create and monitor your first cloud agent run via the Oz API or SDK
  in ~5 minutes.
---
...
* **See a real-world example** - [Demo: Sentry monitoring with SDK](demo-sentry-monitoring-with-sdk.md) shows how to build a webhook handler that triggers agents from production errors.
