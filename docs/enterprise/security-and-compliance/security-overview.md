...
* **Open source client** - Warp's client code is published under [AGPL v3](https://github.com/warpdotdev/warp/blob/main/LICENSE) at [`warpdotdev/warp`](https://github.com/warpdotdev/warp), so security teams can audit the codebase directly. See [Contributing to Warp](https://docs.warp.dev/support-and-community/community/contributing) for the source repository and the security reporting process.
...
See [Single Sign-On (SSO)](sso.md) for setup instructions, SCIM provisioning, account linking, and troubleshooting.
...
See [Bring Your Own LLM](../enterprise-features/bring-your-own-llm.md) for configuration details.
