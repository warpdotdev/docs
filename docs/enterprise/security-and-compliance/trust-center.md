---
description: >-
  Access Warp's security documentation, compliance certifications, and third-party assessment resources to complete your vendor security review.
---
...
* **[Security overview](security-overview.md)** - Warp's security architecture, data handling, and compliance certifications
...
<!-- TODO: Uncomment once Architecture and deployment article ships with PR #642
* **[Architecture and deployment](../enterprise-features/architecture-and-deployment.md)** - Details about Warp's infrastructure, deployment models, and data flows
-->
