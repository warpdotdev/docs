...
See the [Admin Panel](admin-panel.md) documentation for details on configuring each setting.
...
* [Getting started for developers](../getting-started/getting-started-developers.md) - Developer onboarding guide
