...
* **Open source client** - Warp's client code is published under [AGPL v3](https://github.com/warpdotdev/warp/blob/main/LICENSE) at [`warpdotdev/warp`](https://github.com/warpdotdev/warp) for security review and audit
...
**For IT admins**: Start with the [Admin Panel](team-management/admin-panel.md) to manage team settings, configure agent policies, and enforce security controls. See [Roles and permissions](team-management/roles-and-permissions.md) for user access details.
