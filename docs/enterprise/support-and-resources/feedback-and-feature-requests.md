---
description: >-
  Report bugs, request features, and get support as a Warp Enterprise customer.
---
...
For detailed log gathering instructions, including how to zip logs and capture crash reports, see [Sending Feedback & Logs](https://docs.warp.dev/support-and-community/troubleshooting-and-support/sending-us-feedback).
...
<!-- TODO: Uncomment once troubleshooting-login.md merges with PR #641 -->
<!-- * [Troubleshooting login](troubleshooting-login.md) - Resolve login and SSO issues -->
