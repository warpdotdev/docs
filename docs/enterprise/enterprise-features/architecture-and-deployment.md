---
description: >-
  Understand Warp's system architecture and choose the right deployment model for your organization - Warp-hosted, self-hosted, or hybrid.
---
...
* [Deployment Patterns](https://docs.warp.dev/agent-platform/cloud-agents/deployment-patterns) - Detailed patterns for CLI-only, Oz-hosted, and self-hosted setups
* [Security overview](../security-and-compliance/security-overview.md) - Data handling, encryption, and compliance details
* [Bring Your Own LLM](bring-your-own-llm.md) - Route inference through your own cloud infrastructure
* [Admin Panel](../team-management/admin-panel.md) - Configure agent policies and security settings
