...
* You have admin access to both Warp's [Admin Panel](../team-management/admin-panel.md) and your AWS IAM settings.
* Team members have the AWS CLI installed locally.

### Step 1: Configure routing policies (admin)

In the [Admin Panel](../team-management/admin-panel.md), configure which models should route through AWS Bedrock:

1. From the [Admin Panel](../team-management/admin-panel.md), navigate to the BYOLLM or model routing settings.
