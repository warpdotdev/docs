...
\
[Generate](../generate.md) lets you look up commands or contextual suggestions as you’re typing. As you’re entering and adjusting a query to look up a command suggestion, you may incur multiple AI requests before selecting a suggestion.\
\
