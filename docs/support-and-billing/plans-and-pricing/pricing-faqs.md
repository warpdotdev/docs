...
To subscribe to any Warp paid plan, start by [creating a Team in Warp](../../knowledge-and-collaboration/teams.md#creating-a-team), even if you're subscribing as an individual. Once your team is created, you can upgrade:
...
* **Pro**, gets you a higher AI credit limits than the Free plan, support for larger codebases with [Codebase Context](../../code/codebase-context.md), and access to premium models with optional pay-as-you-go overages.
...
* Create unlimited [Notebooks](../../knowledge-and-collaboration/warp-drive/notebooks.md) and [Workflows](../../knowledge-and-collaboration/warp-drive/workflows.md) in Warp Drive to organize and share knowledge across your team.
...
Overages allow for pay-as-you-go access to premium AI models after reaching your monthly quota on Warp plans. Please see more details in our [Overages](usage-overages.md) page.
