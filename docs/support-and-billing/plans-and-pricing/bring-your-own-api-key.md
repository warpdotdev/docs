...
This lets you use your own API keys to access models directly, giving you full control over model selection, billing, and data routing. See [model-choice.md](../../agents/using-agents/model-choice.md "mention") for a list of supported models.

BYOK provides greater flexibility in model access and ensures Warp **never consumes your** [ai-credits.md](ai-credits.md "mention") for requests routed through your own keys.
...
* Warp **does not consume** any of your [ai-credits.md](ai-credits.md "mention").
...
3. Once added, you'll see a **key icon** next to supported models in the model picker in the [universal-input](../../terminal/universal-input/ "mention").&#x20;
...
<table><thead><tr><th width="194.06533813476562">Feature</th><th width="191.20095825195312">Uses Warp's AI Credits</th><th>Description</th></tr></thead><tbody><tr><td><a data-mention href="../../agents/active-ai.md">active-ai.md</a></td><td>No</td><td>Always included with Build and higher plans.</td></tr><tr><td><a data-mention href="../../code/codebase-context.md">codebase-context.md</a></td><td>Yes</td><td>Uses Warp's AI infrastructure and consumes credits.</td></tr></tbody></table>
