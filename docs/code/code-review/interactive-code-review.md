...
{% embed url="https://www.youtube.com/watch?v=gsqWxssx1Mw" %}

**Interactive Code Review builds on Warp’s existing** [.](./ "mention") **panel.** For details on diff views, reverting hunks, opening files, and all available entry points, see the Code Review documentation.&#x20;

{% hint style="info" %}
Note that both the [.](./ "mention") panel and Interactive Code Review require working in a Git-indexed directory.
{% endhint %}
