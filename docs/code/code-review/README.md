...
{% hint style="info" %}
To review agent-generated diffs, leave inline comments, batch your feedback, and have the agent apply all requested changes, see [interactive-code-review.md](interactive-code-review.md "mention").
{% endhint %}
