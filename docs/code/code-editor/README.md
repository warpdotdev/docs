...
3. **Browse via the** [file-tree.md](file-tree.md "mention") to open or create files.
4. **Opening a generated code diff** from an Agent Conversation: [reviewing-code.md](../reviewing-code.md "mention").
...
* [file-tree.md](file-tree.md "mention") — Browse, open, and manage your project with Warp’s native file tree.
* [find-and-replace.md](find-and-replace.md "mention") — Use Warp’s built-in find and replace to quickly search across a file, jump between matches, and make precise edits with options for regex, case sensitivity, and smart case preservation.
* [code-editor-vim-keybindings.md](code-editor-vim-keybindings.md "mention") - Use Vim keybindings to edit code and text in Warp's native code editor.
