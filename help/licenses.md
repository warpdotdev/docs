---
description: These are the licenses of third-party libraries that Warp depends on.
---
...
| base64                        | Apache-2.0 OR MIT                                   |                                   alicemaz/rust-base64 |
...
| cookie                        | Apache-2.0 OR MIT                                   |                                 alexcrichton/cookie-rs |
| cookie\_store                 | Apache-2.0 OR MIT                                   |                                  pfernie/cookie\_store |
...
| crossbeam-epoch               | Apache-2.0 OR MIT                                   |                                 crossbeam-rs/crossbeam |
| crossbeam-queue               | Apache-2.0 AND BSD-2-Clause OR MIT                  |                                 crossbeam-rs/crossbeam |
...
| futures                       | Apache-2.0 OR MIT                                   |                           rust-lang-nursery/futures-rs |
...
| futures-cpupool               | Apache-2.0 OR MIT                                   |                                alexcrichton/futures-rs |
...
| mime\_guess                   | MIT                                                 |                                  abonander/mime\_guess |
...
| publicsuffix                  | Apache-2.0 OR MIT                                   |                                 rushmorem/publicsuffix |
...
| rand\_hc                      | Apache-2.0 OR MIT                                   |                                       rust-random/rand |
| rand\_hc                      | Apache-2.0 OR MIT                                   |                                       rust-random/rand |
| rand\_isaac                   | Apache-2.0 OR MIT                                   |                                       rust-random/rand |
| rand\_jitter                  | Apache-2.0 OR MIT                                   |                                       rust-random/rand |
| rand\_os                      | Apache-2.0 OR MIT                                   |                                       rust-random/rand |
| rand\_pcg                     | Apache-2.0 OR MIT                                   |                                       rust-random/rand |
| rand\_xorshift                | Apache-2.0 OR MIT                                   |                                       rust-random/rand |
| rand\_xoshiro                 | Apache-2.0 OR MIT                                   |                                       rust-random/rand |
| rayon                         | Apache-2.0 OR MIT                                   |                                         rayon-rs/rayon |
| rayon-core                    | Apache-2.0 OR MIT                                   |                                         rayon-rs/rayon |
| rctree                        | MIT                                                 |                                      RazrFalcon/rctree |
| rdrand                        | ISC                                                 |                                   nagisa/rust\_rdrand/ |
| redox\_syscall                | MIT                                                 |                                                        |
| redox\_syscall                | MIT                                                 |                                                        |
| redox\_users                  | MIT                                                 |                                                        |
...
| sized-chunks                  | MPL-2.0+                                            |                                     bodil/sized-chunks |
...
| tokio                         | MIT                                                 |                                         tokio-rs/tokio |
| tokio                         | MIT                                                 |                                         tokio-rs/tokio |
| tokio-buf                     | MIT                                                 |                                         tokio-rs/tokio |
| tokio-current-thread          | MIT                                                 |                                         tokio-rs/tokio |
| tokio-executor                | MIT                                                 |                                         tokio-rs/tokio |
| tokio-io                      | MIT                                                 |                                         tokio-rs/tokio |
| tokio-native-tls              | MIT                                                 |                                           tokio-rs/tls |
| tokio-reactor                 | MIT                                                 |                                         tokio-rs/tokio |
| tokio-sync                    | MIT                                                 |                                         tokio-rs/tokio |
| tokio-tcp                     | MIT                                                 |                                         tokio-rs/tokio |
| tokio-threadpool              | MIT                                                 |                                         tokio-rs/tokio |
| tokio-timer                   | MIT                                                 |                                         tokio-rs/tokio |
| tokio-tls                     | MIT                                                 |                                         tokio-rs/tokio |
...
| try\_from                     | MIT                                                 |                                      derekjw/try\_from |
...
| unicase                       | Apache-2.0 OR MIT                                   |                                    seanmonstar/unicase |
