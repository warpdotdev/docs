...
| cookie_store | Apache-2.0 OR MIT |  pfernie/cookie_store |
...
| mime_guess | MIT |  abonander/mime_guess |
...
| rand_hc | Apache-2.0 OR MIT |  rust-random/rand |
| rand_hc | Apache-2.0 OR MIT |  rust-random/rand |
| rand_isaac | Apache-2.0 OR MIT |  rust-random/rand |
| rand_jitter | Apache-2.0 OR MIT |  rust-random/rand |
| rand_os | Apache-2.0 OR MIT |  rust-random/rand |
| rand_pcg | Apache-2.0 OR MIT |  rust-random/rand |
| rand_xorshift | Apache-2.0 OR MIT |  rust-random/rand |
| rand_xoshiro | Apache-2.0 OR MIT |  rust-random/rand |
| rayon | Apache-2.0 OR MIT |  rayon-rs/rayon |
| rayon-core | Apache-2.0 OR MIT |  rayon-rs/rayon |
| rctree | MIT |  RazrFalcon/rctree |
| rdrand | ISC |  nagisa/rust_rdrand/ |
| redox_syscall | MIT |   |
| redox_syscall | MIT |   |
| redox_users | MIT |   |
