...
Clicking it should open a login pop-up. If clicking the signup buttons opens a blank pop-up window, try using a proxy. It is possible that your ISP or Firewall is blocking the app's call to `*.googleapis.com`. If signing up does not work after trying the steps below, fill out [this Typeform](https://zachlloyd.typeform.com/to/UnZu0akR#\&question=sign\_up?utm\_source=docs) and our team will reach out to you.
