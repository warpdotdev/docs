...
* **A Git repository where the Agent will work** — Warp auto-discovers Skills from `.agents/skills/` in your current working directory up through the repo root. See [Skills](https://docs.warp.dev/agent-platform/warp-agents/skills) for the full list of supported directories and how discovery works.
...
{% embed url="https://www.youtube.com/watch?v=WyMTjXSplRU" %}
Walkthrough of installing the two Skills in a dbt repo, running a simple data lookup, and producing a reproducible deep-dive analysis, plus extending the pattern to Slack with an Oz cloud agent.
{% endembed %}
...
* [Trigger reusable actions with saved prompts](../beginner/trigger-reusable-actions-with-saved-prompts.md) — another reusable Agent primitive, useful for scaffolding frequent data questions
* [Create project rules](../beginner/how-to-create-project-rules-for-an-existing-project-astro-+-typescript-+-tailwind.md) — pair Skills with Rules to steer Agent behavior across your repo
