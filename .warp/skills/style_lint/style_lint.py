#!/usr/bin/env python3
"""Style lint for Warp GitBook documentation.
...
EXCLUDED_DIRS = {"_book", "node_modules", ".gitbook"}
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Style lint for Warp GitBook docs")
