...
Crawls the GitBook sitemap index, fetches every page, and checks for common
SEO issues:
...
# ---------------------------------------------------------------------------
# GitBook space → local directory mapping
# ---------------------------------------------------------------------------
# GitBook publishes each space at a URL prefix. The "warp" space is the site
...
# is appended by GitBook.  We check the full rendered title.
TITLE_MIN = 20
TITLE_MAX = 70
DESC_MIN = 50
DESC_MAX = 160
...
def main():
    ...
    parser.add_argument("--repo-root", default=None,
                        help="Path to the gitbook repo root for source-file mapping")
