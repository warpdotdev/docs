...
- `docs/warp/` — Warp Terminal and IDE (getting started, terminal, code editor, knowledge & collaboration)
- `docs/agent-platform/` — Agent Platform (local agents, cloud agents, capabilities, integrations)
- `docs/reference/` — Technical reference (Oz CLI, API & SDK)
- `docs/support-and-community/` — Support (troubleshooting, billing, privacy)
- `docs/enterprise/` — Enterprise
- `docs/changelog/` — Changelog

Search strategy:
- Use `codebase_semantic_search` on the gitbook repo to find relevant doc pages for the user's question.
...
- Check `SUMMARY.md` files in the relevant section if you need to locate a page by name.
...
| File path | URL |
|---|---|
| `docs/warp/{path}.md` | `https://docs.warp.dev/{path}` |
| `docs/agent-platform/{path}.md` | `https://docs.warp.dev/agent-platform/{path}` |
| `docs/reference/{path}.md` | `https://docs.warp.dev/reference/{path}` |
| `docs/support-and-community/{path}.md` | `https://docs.warp.dev/support-and-community/{path}` |
| `docs/enterprise/{path}.md` | `https://docs.warp.dev/enterprise/{path}` |
| `docs/changelog/{path}.md` | `https://docs.warp.dev/changelog/{path}` |

Key rules:
- **`docs/warp/` is the homepage space** — the `warp/` prefix is NOT included in URLs. Example: `docs/warp/terminal/blocks/block-basics.md` → `https://docs.warp.dev/terminal/blocks/block-basics`
- All other spaces include the space name in the URL. Example: `docs/agent-platform/capabilities/skills.md` → `https://docs.warp.dev/agent-platform/capabilities/skills`
- Strip the `.md` extension.
- `README.md` resolves to the parent directory path. Example: `docs/agent-platform/cloud-agents/integrations/README.md` → `https://docs.warp.dev/agent-platform/cloud-agents/integrations`
