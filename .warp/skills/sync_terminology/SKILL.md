...
Keep `.warp/references/terminology.md` in sync with the canonical [Notion Dictionary](https://www.notion.so/warpdev/Dictionary-31343263616d80a698e5d0a11ff03c5f).
...
- You must be in the `warpdotdev/gitbook` repo
...
```
notion-fetch with id: "31343263616d80a698e5d0a11ff03c5f"
```
...
Notion Dictionary. @oliviajohnston — please add these to the Dictionary
page, or let us know if they should be removed from the repo.
