...
## <!-- Usage/configuration section (rename to match the feature, e.g., "Creating environments", "Configuring integrations") -->
...
### <!-- Task name (e.g., "Create an environment with the CLI") -->

1. Step description.
2. Step description.
3. Step description.

## <!-- Additional sections as needed (e.g., "Managing X", "Advanced usage") -->
