...
# <!-- Task-oriented title (sentence case). Title convention: gerund — "Configuring X" or "Managing X" -->
...
## <!-- Primary task name (e.g., "Creating API keys") -->

<!-- Brief motivation: why the reader would do this (1 sentence).
     Then numbered steps. -->

1. <!-- Motivate if non-obvious. --> Step description.
   <!-- Expected outcome after this step (optional). -->
2. Step description.
3. Step description.
...
## <!-- Secondary task or follow-up (e.g., "Managing API keys") -->
