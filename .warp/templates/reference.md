...
# <!-- Title (sentence case). Title convention: noun describing contents — "CLI commands", "Keyboard shortcuts" -->

<!-- Brief intro: what this reference covers and how to use it.
     1-2 sentences. This is for lookup, not learning. -->

## <!-- Section name (e.g., "Installing the CLI", "Authentication") -->

<!-- Introductory sentence or conceptual context for this section. -->

## <!-- Command/endpoint/option group (e.g., "Running agents") -->
