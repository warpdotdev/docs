...
<VideoEmbed url="https://youtu.be/OyrpkeL6WNY?si=E1rDShRA0CisOwZp" title="Creating rules for agents in Warp video" />
...
### 3. Stashing changes and creating a Rule
