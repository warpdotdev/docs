---
title: "Create project Rules for an existing project"
description: >-
...
<VideoEmbed url="https://youtu.be/SCYovBn4TnM?si=7wZEuTQAFUpcoFJx" title="Creating project rules for an Astro TypeScript Tailwind project video" />
