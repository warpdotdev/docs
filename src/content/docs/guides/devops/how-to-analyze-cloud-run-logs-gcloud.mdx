---
title: "Analyze Cloud Run logs (gcloud)"
description: >-
...
<VideoEmbed url="https://youtu.be/GJ0NepZmmv8?si=MHhAVD2JeTLYc9rM" title="Analyzing Google Cloud Run logs with Warp video" />
