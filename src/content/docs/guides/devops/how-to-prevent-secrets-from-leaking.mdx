---
title: "Prevent secrets from leaking"
description: >-
  Use Warp Rules and built-in Secret Redaction to prevent API keys and
...
<VideoEmbed url="https://youtu.be/2ECPFKtQpVk?si=HHw14Tqj-QyHeByX" title="Preventing secrets from leaking with Warp video" />
