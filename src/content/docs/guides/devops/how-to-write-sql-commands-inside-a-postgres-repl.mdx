---
title: "Write SQL commands inside a Postgres REPL"
description: >-
...
<VideoEmbed url="https://www.youtube.com/watch?v=guXQSMq_Yss" title="Writing SQL commands inside a Postgres REPL with Warp video" />
...
* `Cmd+I` activates Warp’s AI input within any interactive shell.
...
:::tip
Next time you’re stuck remembering a command in Postgres or Python, hit `Cmd+I` and just ask Warp in plain English.
:::
