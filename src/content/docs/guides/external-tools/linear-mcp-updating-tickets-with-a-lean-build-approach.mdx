---
title: "Linear MCP: update tickets with a lean build approach"
description: >-
...
<VideoEmbed url="https://www.youtube.com/watch?v=hqleW6jDCbY" title="Using Linear MCP to update tickets with a lean build workflow video" />
