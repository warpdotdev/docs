...
- [Custom inference endpoint](/agent-platform/inference/custom-inference-endpoint/) — connect Warp's agent to your local Ollama instance for a fully local, no-API-cost agent workflow
