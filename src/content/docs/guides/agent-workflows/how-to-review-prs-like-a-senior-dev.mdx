...
# Or open the PR in your browser for full context
...
- **Select terminal output** — Run `gh pr diff PR_NUMBER` or `git diff`, then select the output block and attach it using the block action menu.
