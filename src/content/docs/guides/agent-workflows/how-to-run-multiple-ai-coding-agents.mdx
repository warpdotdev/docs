...
| Repeatable fleet workflow | You want the same agent pattern on every PR, issue, schedule, or release. | Use an Oz cloud agent with a trigger, skill, or API workflow, then inspect parent and child runs in the [Oz web app](/agent-platform/cloud-agents/oz-web-app/). |
...
* **Clear observability** across parent and child runs in the [Oz web app](/agent-platform/cloud-agents/oz-web-app/) or cloud agent management views.
