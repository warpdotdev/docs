...
* [Automations](/factories/automations/) — The managed product's equivalent of the label-based state machine you just wired by hand.
* [Factory agents](/factories/factory-agents/) — The managed product's take on the same four roles: Triage, Spec, Implement, and Review.
