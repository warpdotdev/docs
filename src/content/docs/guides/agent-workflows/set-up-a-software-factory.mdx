...
* Each agent role working individually. Follow the individual guides first:
  * [Build a triage agent](/guides/agent-workflows/build-a-triage-agent)
  * [Write product and tech specs with agents](/guides/agent-workflows/write-product-and-tech-specs-with-agents)
