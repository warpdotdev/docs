...
* An {VARS.WARP_AUTOMATION_PLATFORM} cloud environment with access to your repository ([create one](/platform/environments#create-an-environment-with-guided-setup-recommended))
