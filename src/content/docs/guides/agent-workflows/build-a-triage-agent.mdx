...
* [Factory agents](/factories/factory-agents/#triage) — The Triage role in the managed product, doing the same job as the agent you just built.
* [Factory skills](/factories/factory-skills/) — How the managed product scopes and shares a skill file like the one you just wrote.
