...
<figcaption>The Code Review button in the top-right corner shows the number of changed files and lines.</figcaption>
</figure>
...
<figcaption>Code Review panel showing diffs with additions highlighted in green.</figcaption>
</figure>
...
<figcaption>File sidebar lists all changed files with addition and deletion counts.</figcaption>
</figure>
...
<figcaption>Inline comments anchor to specific lines so the agent knows exactly what to fix.</figcaption>
</figure>
