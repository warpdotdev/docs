...
* **A working factory loop** — Follow [Set up your software factory: from triage to PR](/guides/agent-workflows/set-up-a-software-factory) to set up the individual agent roles first.
