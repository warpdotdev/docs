...
* Exposes task lifecycle operations via the [Oz CLI](/reference/cli/) and a [REST API](https://docs.warp.dev/reference/api-and-sdk/agent) (create tasks, query history, and inspect status/outputs).
