...
title: Overview
description: >-
  Oz Cloud Agents are cloud-connected background agents that run from events,
  schedules, or integrations, giving teams scalable automation with shared
  observability and centralized configs
---
...
The Oz Platform exposes task visibility via the [**Oz Agent API and SDKs**](/reference/api-and-sdk/), so teams can:
...
For more details, please refer to: [Access, Billing, and Identity Permissions](/agent-platform/cloud-agents/team-access-billing-and-identity/)
...
* [Oz Platform](/agent-platform/cloud-agents/platform/) — CLI, Oz Agent API/SDK, orchestration, tasks, environments, hosts, integrations, and more.
...
* [Oz Agent API and SDK](/reference/api-and-sdk/) — documents the REST API for creating, querying, and monitoring agent tasks programmatically.
