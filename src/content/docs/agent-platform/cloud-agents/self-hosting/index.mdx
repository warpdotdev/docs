...
## Can source code stay on your infrastructure?

Yes, self-hosting keeps repository clones, source files, build artifacts, runtime secrets, and agent execution workspaces on infrastructure you control. This is the right deployment pattern when agent workloads need to run inside your network boundary or reach private services behind your VPN or firewall.
