...
Watch this walkthrough to see how to move a local Warp Agent conversation into an Oz cloud agent run.
...
* **An active local conversation** - Have a [Warp Agent](/agent-platform/local-agents/overview/) conversation open in Warp with the work you want to hand off.
