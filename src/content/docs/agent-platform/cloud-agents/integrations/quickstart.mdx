...
:::tip
If the integration cannot be created or your first run cannot start, use the returned error code to narrow the fix.

* [`feature_not_available`](/reference/api-and-sdk/troubleshooting/errors/feature-not-available/) or [`insufficient_credits`](/reference/api-and-sdk/troubleshooting/errors/insufficient-credits/): plan or credit issues
