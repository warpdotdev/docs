...
description: >-
  ...
  in the cloud, and create pull requests while keeping you updated through
...
![](../../../../../assets/agent-platform/linear-warp-on-web.png)
...
Setup involves two steps powered by the [Oz CLI](https://docs.warp.dev/reference/cli). For more instructions, see [Integrations Overview](/agent-platform/cloud-agents/integrations/).
