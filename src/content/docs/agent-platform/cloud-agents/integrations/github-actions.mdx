...
If the `warp_api_key` secret is missing, invalid, or expired, the action can return an [`authentication_required` error](/reference/api-and-sdk/troubleshooting/errors/authentication-required/).
