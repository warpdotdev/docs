...
Scheduled Agents support the same [model selection](https://docs.warp.dev/reference/cli/) and [MCP server configuration](/agent-platform/cloud-agents/mcp/) as other cloud agent triggers.
