...
* **Warp desktop app** - Download from [Warp homepage](https://www.warp.dev)
* **Warp account** - Create an account at [Oz web app](https://oz.warp.dev)
...
If you don't have Warp yet, download it from [Warp homepage](https://www.warp.dev) and sign in to your account. When you open the Warp desktop app, you're automatically authenticated to Warp's services.
...
* Go to [Oz web app](https://oz.warp.dev) and navigate to the `Runs` tab.
