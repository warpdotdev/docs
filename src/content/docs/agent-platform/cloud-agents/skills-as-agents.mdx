...
:::note
You can also list available skills programmatically using the `GET /agent` endpoint. See the [Oz Agent API](/reference/api-and-sdk/) reference for details.
:::
...
* [Oz Agent API & SDK](/reference/api-and-sdk/) — Programmatic access to cloud agents
