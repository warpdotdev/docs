...
![The Oz Web App welcome page.](../../../../assets/agent-platform/oz-web-app-welcome.png)
...
:::note
For advanced environment configuration, see [Environments](/agent-platform/cloud-agents/environments/) and the [CLI reference](https://docs.warp.dev/reference/cli/integration-setup).
:::
