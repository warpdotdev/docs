...
* Are accessible to both the GitHub app and the triggering user. Missing GitHub authorization can return [`external_authentication_required`](/reference/api-and-sdk/troubleshooting/errors/external-authentication-required/), while insufficient permissions can return [`not_authorized`](/reference/api-and-sdk/troubleshooting/errors/not-authorized/).
