...
![](../../../../../assets/agent-platform/conversation-forking-palette.png)
...
![](../../../../../assets/agent-platform/conversation-forking-open-conversations.png)

You can also access this conversation view from the [universal input chip](https://docs.warp.dev/universal-input) in the current conversation.

![](../../../../../assets/agent-platform/conversation-forking-chip.png)
...
![](../../../../../assets/agent-platform/conversation-forking-footer.png)
...
![](../../../../../assets/agent-platform/conversation-fork-and-compact.png)
