...
<Tabs>
  ...
  <TabItem label="Windows">
    * Press and hold the right `Alt` key (configurable) to start recording
    * Speak your command or query while holding the key
...
<figcaption>Voice input settings.</figcaption>
</figure>
...
<figcaption>Voice input in a Warp editor.</figcaption>
</figure>
