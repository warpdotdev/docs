...
<figcaption>Voice settings panel showing hotkey configuration and voice input toggle options</figcaption>
</figure>
...
<figcaption>Voice input works across Warp's editor interfaces, including the Find dialog and other input editors</figcaption>
</figure>
