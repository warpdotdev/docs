...
description: >-
  ...
  allowing you to attach context blocks, follow up on previous queries, or
  begin new threads for distinct tasks.
---
...
![](../../../../../assets/agent-platform/agent-tips.png)
...
![](../../../../../assets/agent-platform/context-window-1.png)

![](../../../../../assets/agent-platform/context-window-2-1.png)

As you approach the limit, the indicator turns red to warn that the context window is nearly full.

![](../../../../../assets/agent-platform/context-window-2.png)
...
![](../../../../../assets/agent-platform/context-window-3.png)
...
![](../../../../../assets/agent-platform/conversation-segmentation.png)
...
![](../../../../../assets/agent-platform/agent-conversations-new-modality.png)
...
In [Agent Modality](/agent-platform/local-agents/interacting-with-agents/agent-modality/), navigation between terminal mode and agent conversations is designed to be direct:
...
Use `esc` or the back button to return to terminal mode, `⌘Y` to open the conversation selector, or `⌘↩` to start a new conversation. For a complete list of keyboard shortcuts and slash commands, see [Agent Modality - Keyboard shortcuts](/agent-platform/local-agents/interacting-with-agents/agent-modality/#keyboard-shortcuts-quick-reference).
