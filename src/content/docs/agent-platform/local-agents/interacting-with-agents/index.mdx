...
<figcaption>Continuing an Agent conversation in Classic Input (with indicator)</figcaption>
</figure>

<figure>
![Continuing an Agent conversation in agent conversation view](../../../../../assets/agent-platform/follow-up-universal-input.png)
<figcaption>Continuing an Agent conversation in agent conversation view</figcaption>
</figure>
