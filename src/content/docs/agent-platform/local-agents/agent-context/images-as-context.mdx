...
<figcaption>Attaching 5 images on the new "Universal" input (bottom left toolbelt)</figcaption>
</figure>

<figure>
![Attaching 4 images on the "Classic" input (bottom right)](../../../../../assets/agent-platform/image-as-context-classic.png)
<figcaption>Attaching 4 images on the "Classic" input (bottom right)</figcaption>
</figure>
