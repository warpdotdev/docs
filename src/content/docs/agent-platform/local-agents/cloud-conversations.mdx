...
See [Interacting with Agents](/agent-platform/local-agents/interacting-with-agents/) for detailed information on navigating and managing conversations, including keyboard shortcuts and the Conversation Panel in [Agent Modality](/agent-platform/local-agents/interacting-with-agents/agent-modality/).
