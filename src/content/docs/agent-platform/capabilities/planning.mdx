...
* **[Multi-agent orchestration](/agent-platform/cloud-agents/orchestration/)** - Use `/plan` or `/orchestrate` to break a complex task into subtasks that run in parallel across local or cloud agents.
