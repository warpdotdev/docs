...
<figcaption>Prompting the agent to create a plan using the slash command.</figcaption>
</figure>
...
<figcaption>Manually referencing the plan using @ to kickoff the plan.</figcaption>
</figure>
...
<figcaption>Option to pass new plan to agent if plan changes during runtime.</figcaption>
</figure>
