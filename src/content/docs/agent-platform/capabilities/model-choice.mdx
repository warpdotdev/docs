...
![Model selector in Warp's Universal Input.](../../../../assets/agent-platform/new-models-oct-2025.png)
...
You can configure the base model for each [Agent Profiles & Permissions](/agent-platform/capabilities/agent-profiles-permissions/), defining the Agent's autonomy, tool access, and other permissions. The base model is also used for [Planning](/agent-platform/capabilities/planning/).
