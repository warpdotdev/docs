...
<figcaption>Completion markers inside the Agent conversation after each task is completed.</figcaption>
</figure>
...
<figcaption>Access the Task List during an Agent conversation in the Task List chip in the conversation.</figcaption>
</figure>
