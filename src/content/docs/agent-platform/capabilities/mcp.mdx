...
* From the [Settings Page](/agent-platform/capabilities/warp:/settings/mcp/): **Settings** > **MCP Servers**
* From [Warp Drive](https://docs.warp.dev/knowledge-and-collaboration/warp-drive): under **Personal** > **MCP Servers**
* From the [Command Palette](https://docs.warp.dev/command-palette): search for `Open MCP Servers`
