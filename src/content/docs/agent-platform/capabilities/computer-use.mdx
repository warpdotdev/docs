...
To enable Computer Use for [Cloud Agents](/agent-platform/cloud-agents/overview/), navigate to **Settings** > **AI** > **Experimental** > **Computer use in Cloud Agents** and toggle to enable.
...
For full API documentation, see the [Oz Agent API & SDK](/reference/api-and-sdk/) reference.
