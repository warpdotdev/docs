...
Credit limits apply to Agent Mode, [Generate](/agent-platform/local-agents/generate/), and [AI autofill in Workflows](https://docs.warp.dev/knowledge-and-collaboration/warp-drive/workflows#ai-autofill).
