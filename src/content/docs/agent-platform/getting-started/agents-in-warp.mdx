...
* **Use your context** - Leverage [Warp Drive](https://docs.warp.dev/knowledge-and-collaboration/warp-drive), [MCP servers](/agent-platform/capabilities/mcp/), [Rules](/agent-platform/capabilities/rules/), and [codebase indexing](/agent-platform/capabilities/codebase-context/) for tailored responses
...
* [**Local Agents Overview**](/agent-platform/local-agents/overview/) - Detailed guide to working with agents in Warp
