...
description: >-
  Reference for the Warp CLI: command-line flags, environment variables, slash
  commands, keyboard shortcuts, and troubleshooting.
---
...
This section covers common {VARS.WARP_CLI} issues: gathering logs for a bug report, fixing sign-in problems, resuming conversations, and keeping the CLI up to date.
