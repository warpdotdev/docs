...
* **[Customization](/cli/configuration/)** - Configure themes, the statusline, and keybindings. Replace the rotating start-screen object with your own ASCII art, and toggle the account, changelog, project, MCP, and animation sections.
