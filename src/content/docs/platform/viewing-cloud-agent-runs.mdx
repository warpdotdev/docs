...
* Inspect context, logs, outputs, and [Computer Use](/agents/capabilities/computer-use/) artifacts such as screenshots and recordings when the run drove a GUI or browser
...
* [Computer Use](/agents/capabilities/computer-use/) — Review GUI and browser work a cloud agent performed inside its sandbox, including [Browser use](/agents/capabilities/computer-use/browser-use/) and [Testing and recordings](/agents/capabilities/computer-use/testing-and-recordings/).
