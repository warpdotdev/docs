...
* Inspect context, logs, outputs, and [Computer Use](/agents/capabilities/computer-use/) artifacts
...
When a cloud agent starts working — for example, from a Slack mention, a Linear issue, or a [CLI](/agents/cli/oz-cli/) trigger — Warp attaches a shareable link to the run.
...
* [Computer Use](/agents/capabilities/computer-use/) — Review GUI and browser work performed by a cloud agent inside its sandbox.
