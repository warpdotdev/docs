...
* Inspect context, logs, outputs, and [Computer Use](/agents/capabilities/computer-use/) artifacts, such as screenshots and recordings
...
* [Computer Use](/agents/capabilities/computer-use/) — Review GUI and browser work performed by a cloud agent inside its sandbox, including [Browser use](/agents/capabilities/computer-use/browser-use/) and [Testing and recordings](/agents/capabilities/computer-use/testing-and-recordings/).
