...
**Google Cloud Storage (`storage.googleapis.com`)** — port 443, for downloading tooling sidecar archives used by managed Docker Sandbox tasks, including the Warp CLI, computer use, and coding CLI tooling.
