...
See [Pulling self-hosted images from a private registry](/platform/self-hosting/private-container-registry/) for image mirroring, authentication, and worker configuration.
...
* [Private container registry](/platform/self-hosting/private-container-registry/) — Mirror worker and task images and configure private-registry pulls.
