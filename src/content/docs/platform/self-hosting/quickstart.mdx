...
* [Managed: Docker](/platform/self-hosting/managed-docker/) — Full Docker backend setup, plus alternate install methods (Homebrew/Linuxbrew, GitHub Releases binaries) if you'd rather not run the worker itself in Docker.
