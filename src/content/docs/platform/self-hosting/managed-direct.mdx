...
Or with a [config file](/platform/self-hosting/reference/#config-file):
...
To reuse a large monorepo without sharing one checkout between concurrent tasks, see [Direct backend monorepo worktrees](/platform/self-hosting/direct-monorepo-worktrees/).
...
* [Direct backend monorepo worktrees](/platform/self-hosting/direct-monorepo-worktrees/) — Create and remove one Git worktree per task with setup and teardown hooks.
...
* [Troubleshooting](/platform/self-hosting/troubleshooting/#direct-backend) — Common Direct-backend issues.
