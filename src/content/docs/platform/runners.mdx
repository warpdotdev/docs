...
* **Flexible OS targets** – Run agents on Linux or macOS, with Windows support coming soon.
...
<Tabs>
  <TabItem label="Linux">
    ...
    Warp-hosted Linux runners support any public x86-64 or ARM64 image. By default, runners use [`warpdotdev/dev-base:latest`](https://hub.docker.com/r/warpdotdev/dev-base).
  ...
  <TabItem label="macOS">
    ...
    * 6 vCPUs, 14 GiB memory
    * 8 vCPUs, 14 GiB memory
    * 12 vCPUs, 28 GiB memory
    * 12 vCPUs, 56 GiB memory
  </TabItem>
</Tabs>
