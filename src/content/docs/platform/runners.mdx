...
## How runners fit into the {VARS.WARP_AUTOMATION_PLATFORM}
...
* [{VARS.WARP_AGENT_CLI} reference](/reference/cli/) – Full command-line reference for the {VARS.WARP_AUTOMATION_PLATFORM} platform.
