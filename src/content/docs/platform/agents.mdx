...
* **API and SDK** — Programmatic runs from your own backend, scripts, or webhooks via the [{VARS.API_SDK_NAME}](/factories/api-and-sdk/).
...
* [{VARS.API_SDK_NAME}](/factories/api-and-sdk/) - Programmatic access to the cloud agent endpoints.
