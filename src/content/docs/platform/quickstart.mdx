...
**Cloud agents** run in a remote environment and can be triggered from events, schedules, integrations, or manually. This enables scaling agents off your laptop, automating development tasks, and building apps on top of agents. {VARS.WARP_AUTOMATION_PLATFORM} handles the orchestration, execution, and observability.
...
* [**Trigger agents from Slack or Linear**](/platform/integrations/quickstart/) - Connect {VARS.WARP_AUTOMATION_PLATFORM} to team tools so mentions and issue updates can launch cloud agent runs.
...
* [**Build programmatic automations**](/reference/api-and-sdk/quickstart/) - Start cloud agent runs from your own systems with the {VARS.WARP_AUTOMATION_PLATFORM} API or SDKs.
