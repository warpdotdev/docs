...
![The ampersand entry point for handoff in a local Warp Agent conversation.](../../../../assets/agents/local-to-cloud-handoff-input-entrypoint.png)
<figcaption>The ampersand handoff entry point.</figcaption>
</figure>

<figure style={{ maxWidth: "375px" }}>
![The slash command menu showing the handoff command in Warp.](../../../../assets/agents/local-to-cloud-handoff-slash-command.png)
...
<figure style={{ maxWidth: "375px" }}>
![The handoff flow showing an environment selector for the cloud run.](../../../../assets/agents/local-to-cloud-handoff-environment-selector.png)
<figcaption>The environment selector in the handoff flow.</figcaption>
</figure>

<figure style={{ maxWidth: "563px" }}>
![The handoff flow with a follow-up prompt entered before submitting.](../../../../assets/agents/local-to-cloud-handoff-follow-up-prompt.png)
