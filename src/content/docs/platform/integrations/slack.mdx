...
Alternatively, install via the [{VARS.WARP_AGENT_CLI}](/agents/cli/oz-cli/):
...
Once removed, Slack will immediately disable the integration for all teammates. Events for a disabled integration can return [`integration_disabled`](/factories/api-and-sdk/troubleshooting/errors/integration-disabled/).
