...
If something isn't working—missing repos, Slack not detecting @Warp, PR failures, or environment configuration issues—see [common environment issues](/platform/environments/#common-issues). It covers:
