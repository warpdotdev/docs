...
:::note
**Want to connect with Linear instead?** The setup is the same — substitute `slack` with `linear` in the CLI commands, or select Linear in the Oz web app. See [Linear](/platform/integrations/linear/) for details.
:::
