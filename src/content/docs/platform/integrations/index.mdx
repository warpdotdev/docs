...
Integrations run on the [{VARS.WARP_AUTOMATION_PLATFORM}](/platform/overview/), which handles the trigger, the [environment](/platform/environments/) the agent executes in, and the record of each run.
