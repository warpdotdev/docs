...
### Scheduling agents with the {VARS.WARP_AGENT_CLI}
...
Scheduled Agents support the same [model selection](/reference/cli/) and [MCP server configuration](/platform/mcp/) as other cloud agent triggers.
