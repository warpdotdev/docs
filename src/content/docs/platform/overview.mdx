...
![Architecture diagram: Warp-designed and customer-defined triggers create an agent task, which the agent orchestrator routes to agent runners on Warp or customer infrastructure](../../../assets/agent-platform/platform-architecture.png)
...
* The {VARS.WARP_AUTOMATION_PLATFORM} orchestrator still manages lifecycle and observability.
...
* [Warp Factories](/factories/) — build a software factory on these primitives.
