...
![Oz Platform architecture showing Trigger, Agent, Environment, and Artifacts components](../../../assets/agents/most-flexible-platform-for-building-with-agents.png)

![Oz Platform detailed architecture showing components, triggers, orchestrator, and agent runners](../../../assets/agents/oz-diagram.png)
