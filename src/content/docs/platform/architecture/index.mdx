...
These pages describe how the {VARS.WARP_AUTOMATION_PLATFORM} is put together and how data moves through it. Each page pairs a diagram with detailed explanations, so you can trace a component or a flow end to end. Use them to evaluate the platform, plan a deployment, or answer security questions.
