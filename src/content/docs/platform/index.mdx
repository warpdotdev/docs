...
The {VARS.WARP_AUTOMATION_PLATFORM} exposes task visibility via the [**{VARS.API_SDK_NAME}**](/factories/api-and-sdk/), so teams can:
...
* [{VARS.API_SDK_NAME}](/factories/api-and-sdk/) — documents the REST API for creating, querying, and monitoring agent tasks programmatically.
