...
Run-level scoping is exposed through the public REST API on the run config. See the [{VARS.API_SDK_NAME} reference](/factories/api-and-sdk/) for the exact field and shape.
