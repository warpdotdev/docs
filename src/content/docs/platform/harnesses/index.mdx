---
title: Harnesses in {{WARP_AUTOMATION_PLATFORM}}
description: >-
...
{VARS.WARP_AUTOMATION_PLATFORM} can run third-party agent harnesses as cloud agents alongside Warp Agent, including [Claude Code](/platform/harnesses/claude-code/) and [Codex](/platform/harnesses/codex/). You choose the harness (agent runtime) that fits the task; the platform around the run stays the same.
...
* [Warp Agent with {VARS.WARP_AUTOMATION_PLATFORM}](/platform/harnesses/warp-agent/) — {VARS.WARP_AUTOMATION_PLATFORM}'s default first-party harness.
