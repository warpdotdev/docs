...
Oz can run third-party agent harnesses as cloud agents alongside Warp Agent, including [Claude Code](/platform/harnesses/claude-code/) and [Codex](/platform/harnesses/codex/). You choose the harness (agent runtime) that fits the task; the platform around the run stays the same.
...
* **Observability** — Every run produces a transcript and shareable session in the [Oz dashboard](/platform/managing-cloud-agents/).
...
![The Warp app Agent harness dropdown showing third-party harness options for a cloud agent.](../../../../assets/agents/cloud-agent-harness-selector-warp-app.png)
...
* [Warp Agent with Oz](/platform/harnesses/warp-agent/) — Oz's default first-party harness.
