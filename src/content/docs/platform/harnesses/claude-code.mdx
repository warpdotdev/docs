---
title: Claude Code with {{WARP_AUTOMATION_PLATFORM}}
description: >-
...
* [Warp Agent with {VARS.WARP_AUTOMATION_PLATFORM}](/platform/harnesses/warp-agent/) — the {VARS.WARP_AUTOMATION_PLATFORM}'s default harness, the only one that can orchestrate Claude Code subagents.
