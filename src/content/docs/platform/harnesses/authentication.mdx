...
![The Oz web app dialog for adding a new Claude Code auth secret.](../../../../assets/agents/claude-code-auth-secret-setup.png)
...
* [Harnesses in Oz](/platform/harnesses/) — overview of third-party harnesses in Oz.
