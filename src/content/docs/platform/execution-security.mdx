...
:::note
This page applies to both the [managed](/factories/self-hosting/#managed-architecture) and [unmanaged](/platform/unmanaged-execution/) architectures. Backend-specific notes call out Docker-, Kubernetes-, and Direct-only considerations.
:::
...
* [Managed self-hosting](/factories/self-hosting/) — Install and operate a managed worker for a factory.
...
* [Self-hosted worker reference](/factories/self-hosting/reference/) — CLI flags and config schema, including every security-relevant option.
