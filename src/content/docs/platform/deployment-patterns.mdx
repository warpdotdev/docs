...
For numbered, step-by-step versions of this architecture, see the [architecture reference](/platform/architecture/) — in particular the [cloud agent run lifecycle](/platform/architecture/cloud-agent-run-lifecycle/).
