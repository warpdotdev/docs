...
* This view also shows a list of your three most recently used repositories and Agent conversations for quick access, as well as a list of recent directories (which behave like running `cd`).
