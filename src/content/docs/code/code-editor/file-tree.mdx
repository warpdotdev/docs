...
* Press `⌘+\` to open the left panel, then assign your own shortcut for File Tree (and Warp Drive) in **Settings** > **Keyboard shortcuts**.
...
<figcaption>Right-click context menu on a folder in the file tree.</figcaption>
</figure>
