...
On Build, Max, and Business plans, [Reload credits](/support-and-community/plans-and-billing/add-on-credits/) (also known as Add-on Credits) are scoped to your individual user under your team. Membership changes affect access to those credits:

* **Leaving the team** - You lose access to any remaining Reload credits attributed to you. If you rejoin the same team later, you regain access to any unused, non-expired credits.
* **An admin removes a member** - That member loses access to any remaining Reload credits attributed to them under this team. If they rejoin later, they regain access to any unused, non-expired credits.
* **An admin deletes the team** - All members lose access to any remaining Reload credits attributed to them under that team.
