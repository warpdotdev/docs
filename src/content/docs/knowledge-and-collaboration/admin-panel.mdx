...
Team administrators can access the Admin Panel directly from the [Warp Admin Panel](https://app.warp.dev/admin/).
...
<figcaption>Admin Panel main interface.</figcaption>
</figure>
...
For complete details about what's included in each plan, visit [Warp pricing](https://www.warp.dev/pricing).
