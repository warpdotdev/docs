...
* From [Warp Drive](/knowledge-and-collaboration/warp-drive/), click **+** and select **Environment variable**.
* From the [Command Palette](/terminal/command-palette/), create a new team or personal environment variable.
...
\
Note: Don't use static variables to replace a secret manager. Use dynamic variables for any sensitive information.
...
1. [Click to load into a current session](/knowledge-and-collaboration/warp-drive/environment-variables/#click-to-load-into-a-current-session)
...
Then, review the confirmation block. If your environment variables are correct, press `Enter` to load them into your session.
...
See the [Warp Drive Import and Export](/knowledge-and-collaboration/warp-drive/#import-and-export) instructions.
