...
<figcaption>A web-based rendering of a Team Workflow.</figcaption>
</figure>
...
* The [Warp web app homepage](https://app.warp.dev/app)
...
:::note
The desktop option is only presented if Warp's web service can detect the Warp app installed locally. Warp desktop opens localhost port 9277 to accomplish this detection. This is done in a separate process that does not have access to your terminal contents.\
\
If you would like to use Warp locally and do not have it installed, please visit the [installation guide](/getting-started/quickstart/installation-and-setup/).
:::
...
2.  You can change this preference at any point in **Settings** > **Features** > **General** > **Open links in desktop app**. This setting is only available while on the web-based version of Warp.

    <figure>
    ![Setting managing how to open links](../../../../assets/terminal/wd-open-links-preference.png)
    <figcaption>Setting managing how to open links.</figcaption>
    </figure>
