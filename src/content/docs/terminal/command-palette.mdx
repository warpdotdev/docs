...
* Activate a specific filter, by clicking on the filter buttons or prepending your search with the following:
  ...
  * `sessions:` will filter for active sessions with [Session Navigation](/sessions/session-navigation/).
  * `launch_configs:` will filter for [Launch Configurations](/sessions/launch-configurations/).
