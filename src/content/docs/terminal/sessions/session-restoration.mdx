...
:::caution
Toggling off Session Restoration will not clear the [SQLite database](/sessions/session-restoration/#session-restoration-database); however, Warp will stop recording new output.
:::
