...
Agents pull directly from your [**Warp Drive**](/terminal/knowledge-and-collaboration/warp-drive/) contents to generate more accurate responses -- including your **Workflows**, **Notebooks**, **Prompts**, and **Environment Variables**.
...
You can create global rules (accessed through [Warp Drive](/terminal/knowledge-and-collaboration/warp-drive/) >**Personal** > **Rules**) or project scoped rules, defined in an `AGENTS.md` file. Note: the filename must be in all caps for Warp to recognize it.
...
1. From the [Warp Drive](/terminal/knowledge-and-collaboration/warp-drive/) >**Personal** > **Rules**
2. From the [Command Palette](/terminal/terminal/command-palette/), search for "Open AI Rules"
