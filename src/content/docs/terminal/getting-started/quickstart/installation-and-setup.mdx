...
description: >-
  Learn how to install Warp and get it running on your machine. All
  installation options support auto-update, ensuring you receive new features,
...
If you are migrating to Warp from a terminal like iTerm2, you can easily import your settings, such as keyboard shortcuts and color themes. For more details, visit the [Migrate to Warp](/terminal/getting-started/migrate-to-warp/) docs.
