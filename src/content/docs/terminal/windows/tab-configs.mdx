...
<figcaption>Saved Tab Configs appear in the + menu. Hover a config to reveal the sidecar panel with Make default, Edit config, and Remove actions.</figcaption>
</figure>
