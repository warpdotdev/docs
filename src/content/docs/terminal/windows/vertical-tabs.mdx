...
<figcaption>Each vertical tab shows the agent name, working directory, branch, and diff stats at a glance.</figcaption>
</figure>
...
<figcaption>Compact mode keeps each pane row to a single line with a short subtitle for quick scanning.</figcaption>
</figure>
...
<figcaption>Vertical tabs show which agent is running, the Git branch, and session status.</figcaption>
</figure>
...
<figcaption>The settings popup lets you switch Density, customize pane titles and metadata, and toggle the hover detail sidecar.</figcaption>
</figure>
...
<figcaption>Pane icons in the vertical tabs panel carry a status badge overlay reflecting each agent's current state.</figcaption>
</figure>
...
<figcaption>Hovering a pane row reveals a floating detail card with full metadata — without changing the focused pane.</figcaption>
</figure>
