...
:::note
You can quickly find all the **pane** shortcuts by using the [Command Palette](/command-palette/). You can also remap the shortcuts to your liking. See [Custom Keyboard Shortcuts](/getting-started/keyboard-shortcuts/#custom-keyboard-shortcuts) for more details.
:::

### CTRL-TAB Behaviour

`CTRL-TAB` shortcut defaults to activate the previous / next [Tabs](/windows/tabs/). You can configure the shortcut to cycle the most recent session, including any Split Panes, in **Settings** > **Features** > **Keys** > **Ctrl-Tab behavior**
