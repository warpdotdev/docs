...
After decreasing Opacity (moving the slider to a value less than `100`), you can also blur or materialize the background.

* On macOS, use the blur slider. Increasing the slider increases the blur radius applied to the background image.
* On Windows, choose a **Window backdrop** material: **No material**, **Mica**, **Acrylic**, or **Mica Alt**. Backdrop is not visible at opacity 100%. In the settings file, this is `appearance.window.backdrop` (`none`, `mica`, `acrylic`, or `mica_alt`).
