...
* Use the [Command Palette](/terminal/command-palette/), then search for "Compact mode" to toggle.
...
Warp [Blocks](/terminal/blocks/) are divided by horizontal lines that separate individual command input and output. These lines create a visual break between different commands that you run in a session.
...
* Use the [Command Palette](/terminal/command-palette/), then search for "Block Dividers".
