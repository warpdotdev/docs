...
:::note
Once a new font is installed in your system, you need to restart Warp for it to show on the list of options. You may also need to select **View all available system fonts** to see the new font.
:::
...
* Toggle **Blinking cursor**, or type "Cursor blink" in the [Command Palette](/terminal/command-palette/) and toggle the setting.

:::note
Cursor type preference is disabled while [Vim keybindings](/terminal/editor/vim/) (vim mode) are active.
:::
