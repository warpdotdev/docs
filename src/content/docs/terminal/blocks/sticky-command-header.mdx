...
<Tabs>
  <TabItem label="macOS">
    ...
    * Toggle by searching for “Sticky Command Header” within the [Command Palette](/command-palette/) or by pressing `CTRL-CMD-S`.
  ...
  <TabItem label="Windows">
    ...
    * Toggle by searching for “Sticky Command Header” within the [Command Palette](/command-palette/) or by setting up a key bind in**Settings** > **Keyboard shortcuts**.
