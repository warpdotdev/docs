...
![Filter a block's output, with the ability to add context lines.](/images/terminal/block_filtering_with_context_lines.gif)
...
![Toggle a block filter on/off.](/images/terminal/block_filtering_toggle.gif)
