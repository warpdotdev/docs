...
description: >-
  ...
  provide hover info, go-to-definition, find references, inline diagnostics,
  and format-on-save for supported languages.
---
...
LSP features stay in sync across [shared buffers](/terminal/code/code-editor/#shared-buffers) — if the same file is open in multiple tabs or panes, diagnostics, hover, and other features reflect the same content regardless of which view you're looking at.
