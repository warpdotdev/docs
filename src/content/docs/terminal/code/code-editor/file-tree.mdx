...
![](../../../../../assets/terminal/filetree-main.png)
...
![](../../../../../assets/terminal/file-tree-project-explorer-tools-panel.png)
...
Clicking on a file opens it directly in Warp’s [**native Code Editor**](/terminal/code/code-editor/), where you can view and edit code in a separate pane or tab.
...
*   **Create new file**: Add a new file directly from the tree.
    ...
    ![](../../../../../assets/terminal/file-tree-new-file.png)
