...
description: >-
  ...
  essentials like syntax highlighting, tabs, find and replace, Vim
  keybindings, and a file tree.
---
...
2.  **Use the file menu in the Command Palette** (`CMD + O` on macOS, `CTRL + SHIFT + O` on Windows or Linux) when in a Git-tracked repo to search for and open files inside that repo.
    ...
    ![](../../../../../assets/terminal/search-files-icon.png)
3. **Browse via the** [File Tree (Project Explorer)](/terminal/code/code-editor/file-tree/) to open or create files.
...
![](../../../../../assets/terminal/tabbed-file-viewer.png)
...
* [Language Server Protocol (LSP)](/terminal/code/code-editor/language-server-protocol/) - Get hover info, go-to-definition, find references, inline diagnostics, and format-on-save powered by language servers for Rust, Go, Python, TypeScript/JavaScript, and C/C++.
* [File Tree (Project Explorer)](/terminal/code/code-editor/file-tree/) - Browse, open, and manage your project with Warp's native file tree.
* [Find and Replace](/terminal/code/code-editor/find-and-replace/) - Use Warp's built-in find and replace to quickly search across a file, jump between matches, and make precise edits with options for regex, case sensitivity, and smart case preservation.
* [Code Editor Vim Keybindings](/terminal/code/code-editor/code-editor-vim-keybindings/) - Use Vim keybindings to edit code and text in Warp's native code editor.
