...
title: Overview
description: >-
  Warp enables intelligent code generation and editing through AI-powered
...
In addition to Warp’s modern, [native code editor](/terminal/code/code-editor/), it includes:
...
* A dedicated [Code Review](/terminal/code/code-review/) experience for reviewing and editing diffs
* [Zero-state and setup flows](/terminal/code/overview/#getting-started-with-coding-in-warp) to quickly start a new project or initialize an existing one
...
<VideoEmbed url="https://screen.studio/share/VwLoR3BE" />
...
* [Code Editor](/terminal/code/code-editor/) - Warp's built-in code editor lets you make quick, in-context edits with essentials like syntax highlighting, tabs, find and replace, Vim keybindings, and a file tree.
  * [Language Server Protocol (LSP)](/terminal/code/code-editor/language-server-protocol/) - Warp integrates with language servers to provide hover info, go-to-definition, find references, inline diagnostics, and format-on-save for Rust, Go, Python, TypeScript/JavaScript, and C/C++.
...
* [Code Review](/terminal/code/code-review/) - review, edit, and manage Git diffs in real time, with options to attach, revert, or open files directly.
