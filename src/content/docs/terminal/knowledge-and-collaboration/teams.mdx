...
![](../../../../assets/terminal/team-creation-settings.png)

If you create a team, you become the team’s admin and will be the only person who can delete the team. Reference [Team roles and permissions](/terminal/knowledge-and-collaboration/teams/#team-roles-and-permissions) for more info.
