...
* [Drive Object](/terminal/knowledge-and-collaboration/warp-drive/#sharing-your-drive-objects) Links
* [Session Sharing](/terminal/knowledge-and-collaboration/session-sharing/#how-to-allow-access-to-collaborators-in-your-session) Links
...
\
If you would like to use Warp locally and do not have it installed, please visit our [installation guide.](/terminal/getting-started/quickstart/installation-and-setup/)
:::
...
![](../../../../../assets/terminal/wd-popup-message.png)
...
3. You can always switch between web and desktop views on a case-by-case basis.
   1.  To switch from a web-view to Desktop for a given object, open the _overflow menu > Open link on Desktop._
       ...
       ![](../../../../../assets/terminal/wd-switch-viewer.png)
   2.  To stay on the web for a given object despite a global Desktop preference, follow the _View on the web_ option that is part of the redirect screen to Desktop.
       ...
       ![](../../../../../assets/terminal/wd-view-on-web.png)
...
* [Warp Drive](/terminal/knowledge-and-collaboration/warp-drive/) - Store and share workflows, prompts, and environment variables
* [Session Sharing](/terminal/knowledge-and-collaboration/session-sharing/) - Collaborate with others in real-time terminal sessions
