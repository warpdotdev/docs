...
Prompts are searchable and easily accessed from the [Command Palette](/terminal/terminal/command-palette/) so you can find and execute them without switching context. They allow you to save and reuse specific and complex AI workflows, making it easier to repeat multi-step tasks with Agent Mode.
...
For detailed information about creating and using enum type arguments, please see the [Enum type arguments section in Workflows documentation](/terminal/knowledge-and-collaboration/warp-drive/workflows/#enum-type-arguments).
...
* From the [Command Palette](/terminal/terminal/command-palette/) or [Command Search](/terminal/terminal/entry/command-search/), search for a Prompt by name or type "prompts:" to see all available prompts and your prompt history
