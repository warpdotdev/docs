...
<VideoEmbed url="https://www.youtube.com/watch?v=8UmreUTTrkg" title="Warp Drive, Teams, and Workflows Demo" />
...
To switch between panels using your keyboard, you can use the “Switch Focus to Left Panel” and “Switch Focus to Right Panel” commands in the [Command Palette](/terminal/terminal/command-palette/).

![](../../../../../assets/terminal/warp_drive_nav2.png)
...
* [Workflows](/terminal/knowledge-and-collaboration/warp-drive/workflows/) import from and export to YAML (.yaml, .yml)
* [Prompts](/terminal/knowledge-and-collaboration/warp-drive/prompts/) import isn't supported at this time, but you can export to YAML (.yaml, .yml)
* [Notebooks](/terminal/knowledge-and-collaboration/warp-drive/notebooks/) import from and export to MARKDOWN (.md)
* [Environment Variables](/terminal/knowledge-and-collaboration/warp-drive/environment-variables/) import isn't supported at this time, but you can export to DOTENV (.env)
...
To manage a Drive object's permissions, navigate to its overflow menu and choose "Share". If the object is open, you can also use the [Command Palette](/terminal/terminal/command-palette/#how-to-access-it) and search for "Share Pane" or click the share button in the pane header:
