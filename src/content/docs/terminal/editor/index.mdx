...
:::note
Text Editor Input also works for [SSH sessions](/warpify/ssh/).
:::
...
* Toggle this feature **Settings** > **Features** > **General** or search for "Copy on select" in the [Command Palette](/command-palette/).
...
* Toggle this feature **Settings** > **Features** > **General** or search for "Autocomplete quotes" in the [Command Palette](/command-palette/).
