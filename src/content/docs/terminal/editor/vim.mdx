...
* Through the [Command Palette](/command-palette/), search for "Vim Keybindings".
...
One exception is the keyboard shortcut for exiting insert mode, which can be rebound under**Settings** > **Keyboard shortcuts** > **Exit Vim Insert Mode**, or through the [Command Palette](/command-palette/) search for "Exit Vim Insert Mode".
