...
:::note
If you are looking to troubleshoot the TMUX SSH feature, see the [SSH](/warpify/ssh/).
:::
...
:::note
Warp [Completions](/command-completions/completions/) for ssh show entries in `~/.ssh/config` and `~/.ssh/known_hosts`
:::
