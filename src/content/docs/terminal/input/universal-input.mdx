...
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| <img src="../../../../assets/terminal/auto-detection-off-terminal-mode.png" alt="Terminal mode enabled with auto-detection off" data-size="original" /> | <img src="../../../../assets/terminal/auto-detection-off-agent-mode.png" alt="Agent Mode enabled with auto-detection off" data-size="original" /> |
