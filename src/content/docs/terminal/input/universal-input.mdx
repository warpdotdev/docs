...
<figcaption>The Universal Input with an Agent prompt and multiple contextual chips active.</figcaption>
</figure>
...
<figcaption>The Agent icon in the Universal input indicates that Agent Mode is active.</figcaption>
</figure>
...
<figcaption>The sparkles in the Classic input indicates that Agent Mode is active.</figcaption>
</figure>
...
<figcaption>Warp displays an option to toggle natural language detection on / off</figcaption>
</figure>
...
<figcaption>Universal Input's contextual input chips, from left to right: conversation management, node version, active directory, Git and code diffs, and 2 attached images.</figcaption>
</figure>
...
<figcaption>The Conversation Management chip displays recent Agent conversations and lets you continue or reopen them directly from the input.</figcaption>
</figure>
...
<figcaption>The Active Directory chip lets you browse directories and open files directly from the input.</figcaption>
</figure>
...
<figcaption>The Git Status chip highlights repository changes and provides quick access to code review.</figcaption>
</figure>
...
<figcaption>The File Attachments chip allows you to add images or files as context for your queries.</figcaption>
</figure>
...
<figcaption>The Node Version chip displays the Node.js version detected in your repository.</figcaption>
</figure>
...
<figcaption>The Input Toolbelt in Warp’s Universal Input, showing quick-access controls for context, slash commands, voice input, attachments, profiles, and model selection.</figcaption>
</figure>
