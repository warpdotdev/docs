...
* **Built-in agents** — Warp ships with Warp Agent (powered by {VARS.WARP_AUTOMATION_PLATFORM}) and supports third-party CLI agents like Claude Code, Codex, and Gemini CLI from the same terminal.
