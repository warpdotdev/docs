...
![Warp, the Agentic Development Environment: Warp Terminal (a modern terminal built for coding with agents) and Oz (the orchestration platform for cloud agents)](../../../assets/terminal/warp-oz-welcome.png)
...
* [**Modern terminal UX**](/terminal/terminal/editor/): Cursor movement, block-based navigation, multi-line editing, syntax highlighting, and rich completions. Built with Rust for high performance.
* [**Code editor**](/terminal/code/overview/): File tree, code editor with LSP support, and interactive code review experience.
...
* **Shared context**: [Warp Drive](/terminal/knowledge-and-collaboration/warp-drive/), [Rules](https://docs.warp.dev/agent-platform/capabilities/rules), and [MCP servers](https://docs.warp.dev/agent-platform/capabilities/mcp) work across both local and cloud agents, so your team's knowledge and tools are always available.
...
* [**Quickstart Guide**](/terminal/quickstart/): Get Warp installed and start coding
