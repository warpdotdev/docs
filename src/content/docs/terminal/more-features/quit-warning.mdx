...
* Open **Settings** > **Features** > **General** and toggle **Show warning before quitting**.
...
* If enabled, when you try to close Warp you will see a pop-up window with a few options listed below:
  * **Yes, quit**, which will close all Warp sessions and running processes.
  ...
  * **Don't ask again**, which is a box you can select to disable the quit warning feature.
