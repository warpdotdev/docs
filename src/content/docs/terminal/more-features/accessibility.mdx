...
:::note
Note that currently, these instructions are for macOS only. Warp doesn't support screen readers on Linux or Windows. We're tracking screen reader support in [GitHub issue #3847](https://github.com/warpdotdev/Warp/issues/3847).
:::
