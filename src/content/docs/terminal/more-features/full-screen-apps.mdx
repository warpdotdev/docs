...
* From the [Command Palette](/command-palette/), search for "Toggle Mouse Reporting"
...
* Go to **Settings** > **Appearance** > **Full-screen Apps** or from the [Command Palette](/command-palette/) search for "Appearance"
