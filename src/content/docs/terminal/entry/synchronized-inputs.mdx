...
With Warp’s synchronized inputs, whatever command you enter in one session syncs to the other sessions in its entirety. In contrast, "broadcast input" typically lets you broadcast individual keystrokes, which may be more suitable for editing parts of commands.

## How to access it

There are two ways to access controls to synchronize inputs:
...
<Tabs>
  <TabItem label="macOS">
    ...
    * Synchronize All Panes in Current Tab `⌥+⌘+I`
    * Stop Synchronizing Any Panes `⌥+⌘+I`
  </TabItem>
...
When you're finished, you can select “Stop Synchronizing Any Panes” to end the synchronization.
