...
* Pressing `CTRL-R` opens the [Command Search](/entry/command-search/) panel and initiates a search of your Command History. To navigate the Command Search panel:
