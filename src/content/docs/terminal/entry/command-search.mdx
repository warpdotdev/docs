...
:::note
Tailor your Command Search experience by toggling off **Show Global Workflows** in **Settings** > **Features** > **Workflows**. When disabled, your search will only include YAML and Warp Drive Workflows.
:::
