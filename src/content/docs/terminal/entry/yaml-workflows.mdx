...
* Open the [Command Search](/entry/command-search/) or Workflow Search `CTRL-SHIFT-R` panel to find Workflows.
...
:::note
Tailor your [Command Search](/entry/command-search/) experience by toggling off "Show Global Workflows" in **Settings** > **Features**. When disabled, your search will exclusively encompass YAML and Warp Drive Workflows.
:::
