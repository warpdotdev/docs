...
description: >-
  The Session Restoration feature enables Warp to restore your session
  history, specifically windows, tabs, and panes, along with the last few
  Blocks in each pane.
---
...
:::caution
Toggling off Session Restoration will not clear the [SQLite database](/terminal/terminal/sessions/session-restoration/#session-restoration-database); however, Warp will stop recording new output.
:::
