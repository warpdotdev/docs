...
1. Open the Session Navigation palette with the [Command Palette](/terminal/terminal/command-palette/), click on **session >\_** or type in "sessions:".
...
`CTRL-TAB` shortcut defaults to activate the previous / next [Tabs](/terminal/terminal/windows/tabs/). You can configure the shortcut to cycle the most recent session, including any [Split Panes](/terminal/terminal/windows/split-panes/), in **Settings** > **Features** > **Keys** > **Ctrl-Tab behavior**
