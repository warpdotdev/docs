...
Warp supports Syntax Highlighting in the [Input Editor.](/terminal/terminal/editor/) It colors each part of a command to help differentiate between sub-commands, options/flags, arguments, and variables.
...
When Syntax Highlighting is enabled, Warp's [Input Editor](/terminal/terminal/editor/) automatically recognizes each part of the command as you type it into the Input Editor, and syntactically highlight them.

### How to enable/disable Syntax Highlighting

Syntax highlighting is enabled by default, to toggle it:

* Through the [Command Palette](/terminal/terminal/command-palette/), search for the "Syntax Highlighting" option and click it (or press enter) to enable/disable.
...
Warp highlights errors in commands that are typed within the [Input Editor](/terminal/terminal/editor/) e.g. if the binary for the command you've typed does not exist.
