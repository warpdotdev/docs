...
:::note
Text Editor Input also works for [SSH sessions](/terminal/terminal/warpify/ssh/).
:::
...
Warp supports copy on select for selectable text within [Blocks](/terminal/terminal/blocks/).

* Toggle this feature **Settings** > **Features** > **General** or search for "Copy on select" in the [Command Palette](/terminal/terminal/command-palette/).
...
* Toggle this feature **Settings** > **Features** > **General** or search for "Autocomplete quotes" in the [Command Palette](/terminal/terminal/command-palette/).
