...
When you run a command that's subshell-compatible, Warp will prompt you and invite you to "Warpify" the subshell which makes all of the modern IDE features of Warp available in that subshell. The list of subshell-compatible commands is configurable in Subshell settings as described [below](/terminal/terminal/warpify/subshells/#configuring-subshell-compatible-commands).
...
![Subshells Demo](/images/terminal/subshells-demo.gif)
