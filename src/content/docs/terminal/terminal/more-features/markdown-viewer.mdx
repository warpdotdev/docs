...
![Clicking a Markdown file link in the output of ls to open it in Warp](/images/terminal/open-markdown-viewer.gif)
...
![Clicking a Markdown file link in the output of ls to open it in Warp](/images/terminal/markdown-raw-rendered-toggle.gif)
...
If the command contains any arguments using the curly brace `{{param}}` syntax, they will be treated as Workflow arguments. Learn more about [Workflows](/terminal/knowledge-and-collaboration/warp-drive/workflows/).

![Demo of running two commands from a Markdown file in Warp](/images/terminal/run-markdown-file-command.gif)
