...
* Through the [Command Palette](/terminal/terminal/command-palette/) by searching for “Settings Sync”
...
When you log in to Warp on another device or through the browser with [Session Sharing](/terminal/knowledge-and-collaboration/session-sharing/), if you have Settings Sync enabled, most of your settings will be the same as they were when you were logged in before.
...
* Custom keybindings (we may in the future). Although, you can set [custom keybinds with a file](/terminal/getting-started/keyboard-shortcuts/#custom-keyboard-shortcuts)
