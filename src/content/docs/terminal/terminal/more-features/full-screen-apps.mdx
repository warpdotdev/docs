...
description: >-
  ...
  supports sending mouse and scroll events directly to the alt-grid or
  adjusting the padding surrounding the apps.
---
...
* From the [Command Palette](/terminal/terminal/command-palette/), search for "Toggle Mouse Reporting"
...
* Go to **Settings** > **Appearance** > **Full-screen Apps** or from the [Command Palette](/terminal/terminal/command-palette/) search for "Appearance"
