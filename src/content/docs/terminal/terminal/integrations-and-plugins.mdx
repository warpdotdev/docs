...
<Tabs>
  <TabItem label="macOS">
    ...
    ![VSCode New Session Shortcut](/images/terminal/vscode_new_session.gif)
...
![JetBrains New Session Shortcut](/images/terminal/jetbrains_external_terminal_config.gif)
...
![JetBrains Configure Keyboard Shortcut](/images/terminal/jetbrains_external_window_keymap_config.gif)
