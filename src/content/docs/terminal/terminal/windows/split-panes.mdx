...
:::note
You can quickly find all the **pane** shortcuts by using the [Command Palette](/terminal/terminal/command-palette/). You can also remap the shortcuts to your liking. See [Custom Keyboard Shortcuts](/terminal/getting-started/keyboard-shortcuts/#custom-keyboard-shortcuts) for more details.
:::

### CTRL-TAB Behaviour

`CTRL-TAB` shortcut defaults to activate the previous / next [Tabs](/terminal/terminal/windows/tabs/). You can configure the shortcut to cycle the most recent session, including any Split Panes, in **Settings** > **Features** > **Keys** > **Ctrl-Tab behavior**
...
![Split Panes Drag and Drop Demo](/images/terminal/split-panes-dragging-demo.gif)
