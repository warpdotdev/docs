...
:::danger
You can continue to use YAML-based workflows, but we recommend using new [workflows in Warp Drive](/terminal/knowledge-and-collaboration/warp-drive/workflows/) instead for a better editing experience.
:::
...
* Open the [Command Search](/terminal/terminal/entry/command-search/) or Workflow Search `CTRL-SHIFT-R` panel to find Workflows.
...
:::note
Tailor your [Command Search](/terminal/terminal/entry/command-search/) experience by toggling off "Show Global Workflows" in **Settings** > **Features**. When disabled, your search will exclusively encompass YAML and Warp Drive Workflows.
:::
