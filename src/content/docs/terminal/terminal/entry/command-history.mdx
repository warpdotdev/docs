...
* Hitting `UP` in the [Input Editor](/terminal/terminal/editor/) brings up your history and performs a prefix search based on input.
* Pressing `CTRL-R` opens the [Command Search](/terminal/terminal/entry/command-search/) panel and initiates a search of your Command History. To navigate the Command Search panel:
