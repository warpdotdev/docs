...
Share a block easily with coworkers or teammates by creating a web permalink. This preserves formatting and makes debugging and sharing output easy. [See Block Sharing Page.](/terminal/terminal/blocks/block-sharing/)
...
:::note
Bookmarks only persist while the session is open, once you close the session they are lost. If you want to save the command and output for later use, [Share the Block](/terminal/terminal/blocks/block-sharing/).
:::
...
Quickly find important information within a Block. [See Find page](/terminal/terminal/blocks/find/)
...
Filter the output lines of a block natively in Warp to quickly focus on a subset of the block. [See Block Filtering Page](/terminal/terminal/blocks/block-filtering/).
