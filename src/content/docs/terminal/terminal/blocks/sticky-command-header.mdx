...
<Tabs>
  <TabItem label="macOS">
    ...
    * Toggle by searching for “Sticky Command Header” within the [Command Palette](/terminal/terminal/command-palette/) or by pressing `CTRL-CMD-S`.
  ...
  <TabItem label="Windows">
    ...
    * Toggle by searching for “Sticky Command Header” within the [Command Palette](/terminal/terminal/command-palette/) or by setting up a key bind in**Settings** > **Keyboard shortcuts**.
...
![Toggle active header and Jump to bottom of block demo](/images/terminal/sticky-header-toggle-active-demo.gif)
