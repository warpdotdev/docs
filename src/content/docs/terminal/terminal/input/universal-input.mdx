...
If you prefer a more traditional terminal input experience, you can switch to [Classic Input](/terminal/terminal/input/classic-input/) in **Settings** > **Appearance** > **Input**. Classic input also supports oh-my-posh, PS1 customizations, and [same line prompt.](/terminal/terminal/appearance/prompt/#same-line-prompt)
...
| ----------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| <img src="../../../../../assets/terminal/auto-detection-agent-mode-1).png" alt="" data-size="original" /> | <img src="../../../../../assets/terminal/auto-detection-terminal-mode.png" alt="" data-size="original" /> |
...
When you're in Agent Mode, the **Agent icon** will be highlighted in the [Universal Input](/terminal/terminal/input/)
...
When you're in a Git-tracked repository, the Git Status chip displays file- and line-level changes. You can switch branches by clicking on the branch name or review modified files in Warp's [native Code Review panel](/terminal/code/code-review/).
