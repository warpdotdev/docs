...
* Toggle the Blinking cursor or from the [Command Palette](/terminal/terminal/command-palette/), type "Cursor blink" and toggle the setting.

:::note
Cursor type preference is disabled while [Vim keybindings](/terminal/terminal/editor/vim/) (vim mode) is active.
:::
