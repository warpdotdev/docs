...
Automatically create new themes based on a background image. Click the `+` button in the theme picker **Settings** > **Appearance** > **Current Theme** or search `Open Theme Picker` within the [Command Palette](/terminal/terminal/command-palette/).
