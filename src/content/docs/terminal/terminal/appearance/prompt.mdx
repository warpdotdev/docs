...
You can use a Shell prompt instead of the Warp prompt by configuring the **PS1** variable or installing a supported shell prompt plugin (see [Shell Prompt Compatibility Table](/terminal/terminal/appearance/prompt/#shell-prompt-compatibility-table)).
...
![Warp Prompt + Custom Prompt Demo](/images/terminal/warp-custom-prompt-demo.gif)
...
| bash \| zsh \| fish \| pwsh | [Starship](https://github.com/starship/starship)                          | [Working\*](/terminal/terminal/appearance/prompt/#starship)                                 |
| bash \| zsh \| fish \| pwsh | [oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh)                | Working                                                         |
| zsh                         | [Powerlevel10k](https://github.com/romkatv/powerlevel10k)                 | [Working\*](/terminal/terminal/appearance/prompt/#powerlevel10k)                            |
| zsh                         | [Spaceship](https://github.com/spaceship-prompt/spaceship-prompt)         | [Working\*](/terminal/terminal/appearance/prompt/#spaceship)                                |
| zsh                         | [oh-my-zsh](https://github.com/ohmyzsh/ohmyzsh)                           | Working                                                         |
| zsh                         | [prezto](https://github.com/sorin-ionescu/prezto)                         | [Working\*](/terminal/terminal/appearance/prompt/#prezto)                                   |
| ssh                         |                                                                           | Working                                                         |
...
Starship prompt may not render properly if your [default shell](/terminal/getting-started/supported-shells/#changing-what-shell-warp-uses) is `/bin/bash`. To [workaround](https://github.com/warpdotdev/Warp/issues/3066#issuecomment-1548643121) the issue, we recommend you upgrade bash, find the path with `echo $(which bash)`, then put the path in **Settings** > **Features** > **Session** > **"Startup shell for new sessions"**.
...
Warp does support [p10k](https://github.com/romkatv/powerlevel10k#installation) version 1.19.0 and above. Ensure you have the latest version installed and restart Warp after the installation/update of p10k. Then enable the custom prompt as stated [above](/terminal/terminal/appearance/prompt/#choosing-your-prompt-type) and it should work.
...
We advise using Warp's default prompt or installing one of the supported tools, see [Compatibility Table](/terminal/terminal/appearance/prompt/#shell-prompt-compatibility-table). You can disable unsupported prompts for Warp as such:
