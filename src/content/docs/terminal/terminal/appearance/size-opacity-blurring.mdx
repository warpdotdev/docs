...
:::note
If [Session Restoration](/terminal/terminal/sessions/session-restoration/) is enabled, Warp will restore the size of the last window closed when you quit the app. Either make sure the custom-sized window is the last one closed, or disable Session Restoration to ensure Warp launches with the custom-sized window.
:::
...
![Window Size Demo](/images/terminal/window_size_demo.gif)
