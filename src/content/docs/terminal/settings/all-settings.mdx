...
* `gemini_enterprise_credentials_enabled` — Whether Warp should route eligible requests through your workspace's Gemini Enterprise Google Cloud project. Type: boolean. Default: `false`.
