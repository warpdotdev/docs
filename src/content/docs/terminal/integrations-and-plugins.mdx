...
<figcaption>Warp's extension for Docker lists available containers.</figcaption>
</figure>
...
:::note
**Terminal Tip**\
Within **Raycast Settings** > **Extensions** > **Apps**, search for Warp and assign the alias "terminal" so that it shows up in search results.
:::

<figure>
![Raycast Terminal Tip](../../../assets/terminal/raycast-terminal-tip.png)
<figcaption>Warp integration with the Raycast launcher.</figcaption>
</figure>
...
<Tabs>
  <TabItem label="macOS">
    Press `⌘+Shift+C` while in [VSCode](https://code.visualstudio.com/docs/terminal/basics) to open a new session in Warp.
...
Then press **OK**. Now you will be able to run **Open Warp** from the Apple Menu under **Tools** > **External Tools**.
