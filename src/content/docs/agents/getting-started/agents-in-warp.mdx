...
description: >-
  ...
  autonomy and permissions, and how to give them the right context.
---
import VideoEmbed from '@components/VideoEmbed.astro';

This page walks through working with agents in Warp: what they can do, how to control their autonomy and permissions with profiles, and how to give them the context they need. For an overview of the agent and the different ways to reach it, see [Agents overview](/agents/).
