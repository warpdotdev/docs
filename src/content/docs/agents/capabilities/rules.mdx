...
sidebar:
  label: "Rules"
description: >-
  Create reusable Global or Project Rules to ensure agents follow your
...
<VideoEmbed url="https://youtu.be/fDr0-3bLxMQ" title="Rules for agents configuration demo" />
...
<figcaption>Project Rules UI open in a Rules pane.</figcaption>
</figure>
...
<figcaption>An agent response showing which rules were applied.</figcaption>
</figure>

<figure>
![Context derived from memory](../../../../assets/agent-platform/context-references-memory.png)
<figcaption>Rules listed as references in an agent conversation.</figcaption>
</figure>
