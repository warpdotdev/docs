...
<figcaption>Slash Commands menu.</figcaption>
</figure>
...
<figcaption>Slash Commands menu with filtered Agent Prompts.</figcaption>
</figure>
...
<figcaption>The /init setup flow, step 1 of 2.</figcaption>
</figure>

<figure>
![/init setup flow; 2 of 2](../../../../assets/agent-platform/init-setup-flow-2.png)
<figcaption>The /init setup flow, step 2 of 2.</figcaption>
</figure>
