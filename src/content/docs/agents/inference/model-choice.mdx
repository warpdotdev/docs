...
The `model_id` values shown below can be used when configuring models via the [{VARS.WARP_AUTOMATION_PLATFORM}](/platform/overview/) or [CLI](/reference/cli/).
...
| GPT-6 Sol | `gpt-6-sol-low` | Low |
| GPT-6 Sol | `gpt-6-sol-medium` | Medium |
| GPT-6 Sol | `gpt-6-sol-high` | High |
| GPT-6 Sol | `gpt-6-sol-xhigh` | Extra High |
| GPT-6 Sol | `gpt-6-sol-max` | Max |
| GPT-6 Luna | `gpt-6-luna-low` | Low |
| GPT-6 Luna | `gpt-6-luna-medium` | Medium |
| GPT-6 Luna | `gpt-6-luna-high` | High |
| GPT-6 Luna | `gpt-6-luna-xhigh` | Extra High |
| GPT-6 Luna | `gpt-6-luna-max` | Max |
...
| --- | --- | --- |
| Claude Opus 5.5 | `claude-5-5-opus-high` | Default effort |
| Claude Opus 5.5 | `claude-5-5-opus-low` | Low effort |
| Claude Opus 5.5 | `claude-5-5-opus-medium` | Medium effort |
| Claude Opus 5.5 | `claude-5-5-opus-xhigh` | Extra high effort |
| Claude Opus 5.5 | `claude-5-5-opus-xhigh-fast` | Fast mode |
| Claude Opus 5.5 | `claude-5-5-opus-max` | Max effort |
...
| Model | `model_id` | Reasoning Level |
| --- | --- | --- |
| Grok 4.7 | `grok-4-7-low` | Low |
| Grok 4.7 | `grok-4-7-medium` | Medium |
| Grok 4.7 | `grok-4-7-high` | High |
| Grok 4.7 | `grok-4-7-xhigh` | Extra High |
...
| Model | `model_id` |
| --- | --- |
| GLM 5.3 Flash | `glm-5.3-flash-fireworks` |
