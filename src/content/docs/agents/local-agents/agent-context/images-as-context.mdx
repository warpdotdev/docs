...
<figcaption>Attaching images in Universal Input.</figcaption>
</figure>

<figure>
![Attaching 4 images on the "Classic" input (bottom right)](../../../../../assets/agent-platform/image-as-context-classic.png)
<figcaption>Attaching images in Classic Input.</figcaption>
</figure>
