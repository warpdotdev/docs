...
* [Warp Agent CLI](/agents/cli/) - Run the same Warp Agent outside the Warp app, in any terminal.
...
* [Voice](/agents/local-agents/interacting-with-agents/voice/) - Talk to Warp's agent using voice commands.
