...
* **System Prompt** - Warp's instructions to the model, including your [rules](/agent-platform/capabilities/rules/).
* **Tool Definitions** - Descriptions of the tools available to the agent, including any [MCP servers](/agent-platform/capabilities/mcp/).
...
* **Images** - Any [images](/agent-platform/local-agents/agent-context/images-as-context/) attached to the conversation.
