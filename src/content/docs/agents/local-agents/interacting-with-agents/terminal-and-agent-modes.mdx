...
* **Agent conversation** - A multi-turn interaction with {VARS.WARP_AUTOMATION_PLATFORM}. Conversations maintain context across exchanges and have their own dedicated view with richer controls.
