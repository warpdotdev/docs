...
:::note
Claude Code and Codex are also supported as harnesses in {VARS.WARP_AUTOMATION_PLATFORM} for [multi-agent orchestration](/platform/orchestration/). See [Harnesses in {VARS.WARP_AUTOMATION_PLATFORM}](/platform/harnesses/).
:::
