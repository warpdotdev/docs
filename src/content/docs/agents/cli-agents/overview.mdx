...
:::note
Claude Code and Codex are also supported as harnesses in Oz for [multi-agent orchestration](/platform/orchestration/). See [Harnesses in Oz](/platform/harnesses/).
:::
...
* [Cloud handoff and orchestration](/cli/cloud-and-orchestration/) — hand off a {VARS.WARP_CLI} conversation to a cloud agent, or run multi-agent orchestration from the terminal
