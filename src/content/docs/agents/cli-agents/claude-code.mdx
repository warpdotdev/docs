...
:::note
Claude Code is also available as a harness in {VARS.WARP_AUTOMATION_PLATFORM} for cloud orchestration. See [Claude Code with {VARS.WARP_AUTOMATION_PLATFORM}](/platform/harnesses/claude-code/).
:::
