...
:::note
Codex is also available as a harness in the {VARS.WARP_AUTOMATION_PLATFORM} for cloud orchestration. See [Codex with the {VARS.WARP_AUTOMATION_PLATFORM}](/platform/harnesses/codex/).
:::
...
* **[Remote Control](/agents/cli-agents/remote-control/)** - Publish your Codex session so you can monitor and steer it from another device.
...
* [Remote Control](/agents/cli-agents/remote-control/) — publish a Codex session to monitor and steer it remotely
