...
:::note
Codex is also available as a harness in {VARS.WARP_AUTOMATION_PLATFORM} for cloud orchestration. See [Codex with {VARS.WARP_AUTOMATION_PLATFORM}](/platform/harnesses/codex/).
:::
