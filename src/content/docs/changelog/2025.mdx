...
* The input editor now supports `CMD-SHIFT-UP/DOWN` on macOS or `CTRL-SHIFT-HOME/END` on Windows/Linux to move and select to the top/bottom of the text buffer.
