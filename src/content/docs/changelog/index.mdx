...
* \[macOS] You can now customize your [App Icon](https://docs.warp.dev/appearance/app-icons) in `Settings > Appearance > Icon`.
...
* A percentage of Warp users may now enable cloud syncing of their Warp settings under `Settings` > `Account`. We are gradually enabling this feature for all Warp users starting in this release. See the [documentation](https://docs.warp.dev/more-features/settings-sync) for more information.
