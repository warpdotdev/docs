...
* [macOS] fix a memory leak on image pasting and app-icon changes.
...
### 2026.04.23 (v0.2026.04.22.08.46)
...
* Added support for file artifacts in AI agent conversations with download functionality and filtering options.
...
* [Windows] Fixed unbounded memory growth on when rendering large amounts of CJK text with a primary font that does not include CJK glyphs.
...
* Fix autosuggestions and completions not appearing after shell bootstrap completes.
...
* [Windows] Fix high memory usage when using a fallback font.
...
### 2026.03.19 (v0.2026.03.18.08.24)

**New features**

* Added a set of bundled MCP skills when using the Figma MCP for better creation/updating of designs.
...
* Fixes issue on macOS where New Window/New Tab menu items and keybindings occasionally became disabled when using global hotkey window.
...
* Fixed onboarding slides cutting off navigation buttons when the window is too short.
* [Windows] Fix path inconsistencies that caused codebases to fail indexing.
...
* [Windows] Fix rendering issues on old Intel UHD integrated GPUs.
...
### 2026.02.26 (v0.2026.02.25.08.24)
...
### 2026.02.09 (v0.2026.02.10.11.37)
...
### 2026.02.05 (v0.2026.02.04.08.20)
...
### 2026.01.31 (v0.2026.01.28.08.14)
...
* Fixed some issues that could cause crashes after terminal grid manipulations. May fix crashes when using Claude Code
...
### 2026.01.29 (v0.2026.01.28.08.14)
...
### 2026.01.22 (v0.2026.01.21.08.14)

**New features**

* Global search in files across your current directories. Use `cmd/ctrl + shift + f` to open.
...
### 2026.01.15 (v0.2026.01.14.08.15)
...
### 2026.01.08 (v0.2026.01.07.08.13)
...
* Fixed an issue where up arrow history could be ordered incorrectly on quit/restart warp.

### 2025.12.18 (v0.2025.12.17.17.17)
...
### 2025.12.11 (v0.2025.12.10.08.12)

**Improvements**

* Added 'Initialize codebase' button to Code Review that appears when you're in an uninitialized repo, making it easier to set up codebase indexing and LSP.
* Added new sub-menu to the model picker for selecting the reasoning level of reasoning models.
...
### 2025.12.04 (v0.2025.12.03.08.12)
...
* Fixed a bug preventing files from opening in Warp.
...
* Fix windows keybinding for "find in code editor." This is now `ctrl+shift+f` on windows and configurable from Settings > Keyboard shortcuts.
...
### 2025.11.26 (v0.2025.11.19.08.12)

**Improvements**

* Save and fill MCP env vars for legacy MCPs.
* Full terminal use update to not allow toggling input mode to terminal mode.
* Performance improvements for code review

### 2025.11.20 (v0.2025.11.19.08.12)
...
* **Full Terminal Use**: Let the agent use the terminal as you would: interact with REPLs, debuggers, and full-screen apps like `top`. Warp is the only product on the market with Full Terminal Use capabilities.  
* `/plan`: do spec-driven development in Warp. Work with an agent to align on an implementation plan that can be saved, versioned, and even attached to a PR for teammates.  
...
### 2025.10.30 (v0.2025.11.05.08.12)
...
* Fixed focus moving from input when Code Review pane is open. * Fixed the close icon from becoming too small on the Warp Drive notebook viewer.
* Fixed an issue where the CLI would report invalid debug IDs in its troubleshooting output.

### 2025.10.17 (v0.2025.10.15.08.12)
...
* Restore closed panes using `cmd-shift-t` on Mac or `ctrl-alt-t` on Windows / Linux within 60 seconds of them being closed.
...
### 2025.10.13 (v0.2025.10.08.08.12)
...
### 2025.10.09 (v0.2025.10.08.08.12)
...
### 2025.10.02 (v0.2025.10.01.08.12)

**Improvements**

* Editing suggested file changes now takes place in the same pane, instead of a new tab.
* When using the @ context menu outside of a repo, the current folder's contents are now listed.
...
### 2025.09.26 (v0.2025.09.24.08.11)
...
### 2025.09.18 (v0.2025.09.17.08.11)
...
### 2025.08.21 (v0.2025.08.27.08.11)

**New features**

* [Agent Profiles](https://docs.warp.dev/~/changes/1082/agents/using-agents/agent-permissions): define how your agent operates
...
### 2025.08.07 (v0.2025.08.13.08.12)
...
### 2025.08.01 (v0.2025.07.30.08.12)
...
### 2025.07.31 (v0.2025.07.30.08.12)
...
### 2025.07.24 (v0.2025.07.23.08.12)

**New features**

* [Windows] Added support for pasting images from the clipboard into Agent Mode context.

**Improvements**

* Added image filenames to the attachment chip when pasting images into Agent Mode context.
...
* Added a Node.js version prompt chip.
...
* Fixed a bug where warpifying a remote session could cause a memory leak.

### 2025.07.16 (v0.2025.07.16.08.12)

**New features**

* Support pasting images from Clipboard into Agent Mode context, for MacOS.
...
### 2025.07.10 (v0.2025.07.09.08.11)

**New features**

* New secret redaction strikethrough UI. Comes with new 'Hide secrets in blocklist' setting that defaults to 'off'.
 ...
 * Support .warpindexingignore for ignoring files and directories during codebase indexing.
 * Higher codebase context repo limit for pro (10k files) and turbo (20k files) plan
...
### 2025.06.18 (v0.2025.06.18.08.11)

**New features**

* Pro and Turbo Plan users now have access to usage-based pricing to gain access to premium models beyond their monthly request limit. Admins can enable in Settings > Billing & Usage.

**Improvements**

* You can now exit refine mode for AI plans and requests to take action on the original suggestion.

**Bug fixes**

* Fixed an issue where the Agent would format filepaths incorrectly when grepping for content.
...
### 2025.06.05 (v0.2025.06.04.08.11)
...
### 2025.05.22 (v0.2025.05.28.08.11)
...
### 2025.05.16 (v0.2025.05.14.08.11)
...
### 2025.05.15 (v0.2025.05.14.08.11)
...
### 2025.05.08 (v0.2025.05.07.08.12)
...
* Stop showing an unexpected <citations /> block in the planning output for o3.
* Fixed hovered file links in WSL sessions.
* Fixed terminal input remaining hidden after cancelling an env var block.
* Prevent unexpected empty code fences in agent mode when using Gemini 2.5 pro or o3.
...
### 2025.04.24 (v0.2025.04.23.08.11)
...
### 2025.04.17 (v0.2025.04.16.08.11)
...
* Get early access to unreleased and experimental features with [Warp Preview](https://www.warp.dev/blog/warp-preview).

**Improvements**

* Improved login item management to respect when users manually remove Warp from startup items in System Preferences.
 * Show a small popup when users who are at AI limits have their quota reset.
 * The input editor now supports CMD-SHIFT-UP/DOWN (on Mac) or CTRL-SHIFT-HOME/END (on Linux/Windows) to move and select to the top/bottom of the text buffer.
...
### 2025.03.25 (v0.2025.03.26.08.10)

**New features**

* Kitty Image Protocol is now supported on Mac and Linux!
...
* The warning dialog for closing sessions now responds to the Enter and Escape keys.
...
### 2025.03.06 (v0.2025.03.05.08.02)

**New features**

* iTerm Image Protocol is now supported on Mac and Linux!
* Warp now starts at login on Mac (can be disabled in System Settings > Login Items & Extensions).
...
* [Windows] Added “Open Warp here” item to File Explorer context menu (under “more options”).
...
* Warp is now available for Windows!
* Prompt, plan, and execute fully autonomous tasks from Agent Mode with Dispatch (Beta)
* Adds codebase context support to Agent Mode. Currently enabled for git repositories only.
* [macOS] You can now customize your dock icon in Settings > Appearance
...
* Fixed prompt chip misalignment for certain fonts.
...
### 2025.02.13 (v0.2025.02.12.16.51)
...
* [mac] Fix hotkey keybinding not triggering on non-US keyboard input source.

### 2025.02.07 (v0.2025.02.05.08.02)

**New features**

* You can now talk to Warp to transcribe Agent Mode prompts or any other text! Set up the hotkey in Settings > AI > Voice or use the microphone button in AI input mode to trigger this. [Learn More](https://docs.warp.dev/features/warp-ai/voice).
...
### 2025.02.04 (v0.2025.02.03.19.20)
...
### 2025.01.22 (v0.2025.01.22.23.18)
...
* A percentage of Warp users may now enable cloud syncing of their Warp settings under `Settings` > `Account`. We are gradually enabling this feature for all Warp users starting in this release. See the [docs](https://docs.warp.dev/features/settings-sync) for more information.
* Introduced a setting to hide the tab bar (Zen mode). See the [docs](https://docs.warp.dev/appearance/tabs-behavior) for more information.
...
[Warp.dev](https://www.warp.dev/) has a fresh look today! Check out what's new and [read about the design process behind the launch](https://www.warp.dev/blog/world-of-warp).
...
* You can now save and sync environment variable collections in Warp Drive. Learn more in the [docs](https://docs.warp.dev/features/warp-drive/environment-variables).
...
* Array-formatted `PROMPT_COMMAND` in a Bash config file can now include semicolons.
...
### Same line prompt
Now you can choose whether you'd like your prompt on a new line (Warp's default) or on the same line with commands, like a classic terminal. If you're using PS1, Warp will use the same line prompt setting to respect theme configurations. Visit Settings > Appearance > Prompt to configure your prompt style.
[Learn more](https://docs.warp.dev/appearance/prompt#same-line-prompt)
...
### New Agent Mode in Warp AI
Use plain English on the command line to accomplish multi-step workflows. [Learn more](https://www.warp.dev/blog/agent-mode)
...
Create and share interactive runbooks with your team. [Learn more](https://www.warp.dev/blog/notebooks-in-warp-drive)
...
[Read the blog](https://www.warp.dev/blog/warp-for-linux) to learn more and download.
...
* [Warp on Linux (Private Beta):](https://www.warp.dev/linux-terminal) System fonts now load as expected


**Bug fixes**

* [Warp on Linux (Private Beta):](https://www.warp.dev/linux-terminal) `ALT-TAB` no longer incorrectly inserts 4 spaces into the Input Editor
...
### Edit commands with Vim keybindings (beta)
...
* Alias Abbreviations should no longer show a red error underline within the Input Editor
...
### **Decide how Tab should behave in your editor**
Choose whether your `TAB` key behavior opens the completions menu or accepts autosuggestions. Configure the behavior under Settings > Features > Editor
...
* Workflows in Warp Drive drive are now be edited with the workflow execution modal
