...
On Build, Max, and Business plans, [Reload credits](/support-and-community/plans-and-billing/add-on-credits/) (also known as Add-on Credits) are scoped to the individual user under your team. Membership changes affect access to those credits:

* **Leaving the team** - You lose access to any remaining Reload credits tied to it. If you rejoin the same team later, you regain access to any unused, non-expired credits.
* **An admin removes a member** - That member loses access to any remaining Reload credits tied to the team. If they rejoin later, they regain access to any unused, non-expired credits.
* **An admin deletes the team** - All members lose access to any remaining Reload credits tied to the team.
...
:::note
Grandfathered pooled Reload credits (purchased before May 21, 2026) remain attached to the team itself rather than any individual user, and are unaffected by individual membership changes. They continue to drain first across the team until exhausted; only post-May-21 purchases are user-scoped.
:::
