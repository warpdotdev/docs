...
* **Admin** - Manages workspace membership, billing, and settings, and has admin-level access to the teams in the workspace. A workspace can have any number of admins.
