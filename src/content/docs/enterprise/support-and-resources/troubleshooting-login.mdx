...
3. Once logged in, visit [SSO linking page](https://app.warp.dev/link_sso).
...
3. Try [Warp login page](https://app.warp.dev/login) again.
...
* **All other users** - Visit [Warp contact page](https://www.warp.dev/contact) for support.
