...
* **{VARS.WARP_AUTOMATION_PLATFORM}** - Warp's programmable platform for running and coordinating agents at scale. {VARS.WARP_AUTOMATION_PLATFORM} powers all agents in Warp, whether they run locally or in the cloud, and provides the orchestration, tracking, and control plane for scalable agent workflows.
