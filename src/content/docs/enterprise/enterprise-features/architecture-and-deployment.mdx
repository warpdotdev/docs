...
**Managed** - Run the `oz-agent-worker` daemon to let the {VARS.WARP_AUTOMATION_PLATFORM} orchestrate agents in isolated Docker containers on your infrastructure.
