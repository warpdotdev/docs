...
For a component-by-component walkthrough of this diagram, see the [stack overview](/platform/architecture/stack-overview/) in the architecture reference.
...
* The worker process connects to the {VARS.WARP_AUTOMATION_PLATFORM} via WebSocket and receives tasks automatically.
