...
:::note
We recommend using this option to test BYOLLM before rolling it out team-wide via Option A. A misconfiguration here only affects that agent's runs, not your whole team.
:::
