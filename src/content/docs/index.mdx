...
Warp is an [open source](https://github.com/warpdotdev/warp) **Agentic Development Environment** for working in the terminal and with coding agents. Use Warp for interactive coding, run the Warp Agent from any terminal, automate recurring work in the cloud, or connect a team workflow to Warp Factories.
