...
This can likely occur due to some corruption in the local sqlite db. You may see a similar error in your [logs](/support-and-community/#gathering-warp-logs):
