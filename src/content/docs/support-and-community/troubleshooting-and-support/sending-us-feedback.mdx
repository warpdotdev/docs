...
The [`/copy-debugging-id`](/agents/capabilities/slash-commands/) slash command copies the same information without leaving the input. It works in both the Warp app and the [{VARS.WARP_CLI}](/cli/), and it applies to the conversation you're currently in:
