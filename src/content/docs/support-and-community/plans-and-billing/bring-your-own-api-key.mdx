...
:::caution
BYOK does not apply to [Oz Cloud Agents](https://docs.warp.dev/agent-platform/cloud-agents/overview). Because your API keys are stored locally on your device, they are not available to cloud-hosted agent runs. Cloud agent runs always consume [Warp credits](/support-and-community/plans-and-billing/credits/).
:::
...
![](../../../../assets/support-and-community/Pricing-Blog-BYOK.png)
...
![](../../../../assets/support-and-community/byok-keys.png)
...
![](../../../../assets/support-and-community/fallback.png)
