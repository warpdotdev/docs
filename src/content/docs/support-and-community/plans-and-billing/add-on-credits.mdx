...
* **The team's payment method** - Every purchase charges the payment method saved for the team, and only admins can change or remove it.

Because purchases bill the team's payment method rather than a per-member card, see [Which card is charged when a team member buys add-on credits?](/support-and-community/plans-and-billing/pricing-faqs/#which-card-is-charged-when-a-team-member-buys-add-on-credits) in the Pricing FAQs for how that works on a shared team.
