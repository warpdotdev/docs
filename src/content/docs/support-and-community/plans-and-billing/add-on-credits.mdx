...
Add-on credits are available on every self-serve plan — Free, Build, Max, and Business — plus Enterprise (with custom pricing). Paid self-serve plans buy at list price; the Free plan buys the same packs at a higher rate, described in [Buying add-on credits on the Free plan](#buying-add-on-credits-on-the-free-plan). On self-serve plans, add-on credits are scoped to each individual user; Enterprise uses a team-pooled model. These credits **roll over across billing cycles** and remain valid for **12 months from the purchase date**.
...
Any active member of a team can purchase add-on credits for their own usage. You don't need to be a team admin, and you don't need a paid subscription. Credits you buy are scoped to you, so they only draw down for your own usage.

Team admins keep the controls that govern team-wide spending:

* **Team-wide monthly spend cap** - Caps what the whole team can spend on add-on credits per calendar month, across all members. The default is $200. Admins set it in the Warp app under **Settings** > **Billing and usage**.
...
:::caution
Because purchases charge the team's saved payment method, a purchase made by one member is billed to whichever card the team already has on file — which may belong to a different member. If you don't want your card used this way, ask a team admin to replace or remove it in the billing portal, or email [billing@warp.dev](mailto:billing@warp.dev).
:::
...
### Buying add-on credits on the Free plan

You don't need a subscription to buy credits. On the Free plan you can purchase the same credit packs and spend them on any model, so a one-off top-up is an alternative to upgrading. Free plan packs cost 20% more than the paid-plan price, which is the trade-off for not carrying a subscription.

| Credits | Free plan price | Paid plan price |
| --- | --- | --- |
| 400 | $12 | $10 |
| 1,000 | $24 | $20 |
| 3,000 | $60 | $50 |
...
Upgrading to a [paid plan](https://www.warp.dev/pricing) drops you to the paid-plan price and adds a monthly credit allowance on top.
...
1. Start the purchase from either surface. In the Warp app, go to **Settings** > **Billing and usage**, choose a denomination, then click **One-time purchase**. On the web, open the [Warp upgrade page](https://app.warp.dev/upgrade) and use the **Add-on credits** card below the plan cards.
...
Stripe saves the card you use at checkout, and Warp sets it as the team's default payment method. From that point on:

* **Later purchases skip checkout** - Add-on credit purchases on that team charge the saved card directly, including purchases made by other team members and any auto-reload an admin turns on.
* **Only admins can change it** - Team admins update or remove the saved card in the billing portal. Non-admin members can't open the billing portal. See [How do I manage my billing?](/support-and-community/plans-and-billing/pricing-faqs/#how-do-i-manage-my-billing).
* **The spend cap still applies** - The team-wide monthly spend cap (default $200) limits total add-on credit spending per calendar month, whoever makes the purchase.

:::caution
On a shared team, this means one member's card can end up funding another member's purchase. If that isn't what you want, ask a team admin to replace or remove the saved card, set a lower team-wide spend cap, or email [billing@warp.dev](mailto:billing@warp.dev) for help.
:::
...
If you move to the Free plan, your remaining add-on credits aren't removed and they keep their original 12-month expiration from the purchase date. You can keep spending them on the Free plan, and you can buy more at the Free plan rate described in [Buying add-on credits on the Free plan](#buying-add-on-credits-on-the-free-plan). Re-subscribing on the same team restores the paid-plan rate for new purchases.
