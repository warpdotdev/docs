...
description: >-
  ...
  monthly credit limit, offering flexible, usage-based pricing with lower
  rates, rollover balance, and full control over spend.
---
...
![](../../../../assets/support-and-community/reload-credits.png)
...
:::caution
You won't be able to use the remaining Add-on Credits with telemetry disabled since we aren't able to properly track credit usage. See more on the telemetry settings in our [Privacy page](/support-and-community/privacy-and-security/privacy/).
:::
