...
Credits you buy this way behave like any other add-on credits: they roll over, stay valid for 12 months from purchase, and remain usable if your team later moves between plans. Upgrading to a paid plan lowers the per-credit rate and adds a monthly credit allowance. See [Buying add-on credits on the Free plan](/support-and-community/plans-and-billing/add-on-credits/#buying-add-on-credits-on-the-free-plan).
...
* **Team-wide monthly spend cap** — Every purchase counts against one cap for the whole team, defaulting to $200 per calendar month. Purchases that would exceed the cap are rejected.
...
Add-on credit purchases charge the payment method saved for the **team**, not a per-member card. That card is whichever one the team already has on file — usually the card an admin entered when subscribing, or the card the first member used when buying credits on a Free plan team.

When a team has no saved card, the purchase goes through Stripe Checkout. Warp then saves that card as the team's default payment method, so later add-on credit purchases and auto-reload can charge it without another checkout. On a Free plan team, this means the first member to buy credits can end up supplying the card that a teammate's later purchase is billed to.
...
* **Buy add-on credits** — purchase a credit pack without subscribing and spend it on any model. Free plan packs cost 20% more than the paid-plan rate. See [Can I buy credits on the Free plan without subscribing?](#can-i-buy-credits-on-the-free-plan-without-subscribing).
