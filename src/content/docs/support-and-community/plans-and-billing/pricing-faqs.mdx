...
Overages allow for pay-as-you-go access to premium AI models after reaching your monthly quota on Warp plans. Please see more details in our [Overages](/support-and-community/plans-and-billing/overages-legacy/) page.
...
If you’d like to continue using premium models beyond your included quota, you can enable [pay-as-you-go overages](/support-and-community/plans-and-billing/overages-legacy/) in **Settings** > **Billing and usage**.
...
For monthly subscriptions, we in general do not issue refunds. Please see [Warp's Refund Policy](/support-and-community/plans-and-billing/pricing-faqs/#warps-refund-policy) for details and exceptions.
...
The Build and new Business plans includes 1,500 monthly credits, the ability to purchase [Add-on Credits](/support-and-community/plans-and-billing/add-on-credits/) that roll over for 12 months, and the ability to bring your own API key. Learn more at [warp.dev/pricing](https://www.warp.dev/pricing).
