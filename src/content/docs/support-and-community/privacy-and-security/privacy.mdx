...
| `AgentMode.SurfacedCitations` | Agent Mode cited external sources used in its response |
...
| `RemoteServer.HostUnsupported` | Preinstall check classified the remote host as unsupported, falling back to the legacy SSH flow |
