...
Allow a few hours for the referral system to process and send email updates. If you still haven’t received an email after a reasonable amount of time, contact us at [referrals@warp.dev](mailto:referrals@warp.dev) and we'll look into it.
