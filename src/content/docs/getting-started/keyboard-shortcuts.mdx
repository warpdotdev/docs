...
<Tabs>
  <TabItem label="macOS">
    **Warp Essentials**
    ...
    | `CMD-\`        | Warp Drive                   | `workspace:toggle_warp_drive`                   |
    | `CMD-O`        | File search                  |                                                |
    ...
    **Blocks**
    ...
    | `SHIFT-CMD-S`     | Share Selected Block              | `terminal:open_share_block_modal`                            |
    ...
    **Input Editor**
    ...
    | `CMD-I`           | Inspect Command                           | `editor_view:inspect_command`                        |
    ...
    **Terminal**
    ...
    | `CMD-,`           | Open Settings                                     | `workspace:show_settings`              |
    ...
    **Fundamentals**
    ...
    | `CMD-T`            | Open New Tab               | `workspace:new_tab`         |
    | `SHIFT-CMD-T`      | Reopen Closed Tab          | `app:reopen_closed_session`    |
