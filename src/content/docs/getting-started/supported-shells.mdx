...
To change the default shell, choose a shell in Warp by going to **Settings** > **Features** and scrolling to the **Session** section, then select **Startup shell for new sessions**.
