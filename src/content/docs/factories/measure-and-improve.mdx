...
A benchmark compares model and runner configurations for a single agent on the same fixed tasks. Use it to test a configuration change before you apply it to production. See [Warp Factories benchmarks](/factories/benchmarks/) for the workflow.
...
* [Warp Factories benchmarks](/factories/benchmarks/) - Compare model and runner configurations on the same tasks.
