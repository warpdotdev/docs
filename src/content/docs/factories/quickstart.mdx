...
:::note
Want to skip the wizard? Ask an agent connected to the [Factory MCP](/factories/factory-mcp/) to run the `create_factory` tool. Tell it the team, repositories, and factory name, then choose agents and connect your tools afterward in the factory's dashboard.
:::
