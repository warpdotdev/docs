...
* Choose the code host and repositories the factory works on.
* Name the factory and its foreman's @-mention alias.
* Choose which default agents the foreman can dispatch.
* Decide whether to connect a chat tool and an issue tracker now, or add them later.
