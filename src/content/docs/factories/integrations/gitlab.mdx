...
description: >-
  Connect GitLab to your factory so merge request events and bot mentions
  start factory work and results post back as comments and merge requests.
sidebar:
  label: "GitLab"
---
...
{/* VISUAL: A merge request comment mentioning the factory's bot username, parallel to the GitHub mention visual. */}
