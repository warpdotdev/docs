...
* **The Oz by Warp GitHub App** - Install the app and grant it access to the repositories the factory works in. Follow the [GitHub integration setup](/platform/integrations/github/) for installation, organization association, and account connection.
