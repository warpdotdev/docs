...
CI payloads carry no issue or label data, so on check suite and workflow run triggers, **Labels** and **Authors** match against the pull request linked to the run.
...
2. Mention **@oz-agent** in the issue or pull request body when you open it, or in any new comment — or assign **@oz-agent** to the issue or pull request.
