...
<figure style={{ maxWidth: "450px" }}>
![A Slack channel where the factory's app acknowledges a bug report, then replies with a follow-up explaining the fix requires an API change, along with a tracked ticket number and links to open the session or view the factory task.](../../../../assets/factories/slack-automation-example.png)
<figcaption>The factory acknowledging a request, then following up with progress and a tracked task.</figcaption>
</figure>
