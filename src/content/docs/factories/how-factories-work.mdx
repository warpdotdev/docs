...
For a numbered walkthrough of every component in this diagram, see the [Warp Factories work-item flow](/platform/architecture/factories-work-item-flow/) architecture reference.
