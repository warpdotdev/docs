...
* **Live-managed** - You edit the factory directly in the control room. There are no definition files.
...
A factory can be created in either mode, and a live-managed factory becomes file-managed once you link a definition source. In every mode, operational state stays in the control room; definition files carry configuration only.
