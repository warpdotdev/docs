...
MCP servers for agents that don't declare their own, in the same form as [`mcpServers`](#mcpservers). Beneath each named server entry, the nested paths are `agentDefaults.mcpServers.<server-name>.warpId`, `agentDefaults.mcpServers.<server-name>.command`, `agentDefaults.mcpServers.<server-name>.args`, `agentDefaults.mcpServers.<server-name>.env`, `agentDefaults.mcpServers.<server-name>.url`, and `agentDefaults.mcpServers.<server-name>.headers`. Like secrets, an agent that declares its own map replaces this one, and factory-wide servers always apply.
...
The `harness` map accepts `harness.type`, `harness.model`, `harness.reasoningLevel`, `harness.auth`, `harness.auth.source`, and `harness.auth.secretName`. Beneath each named server entry, an agent's MCP map accepts `mcpServers.<server-name>.warpId`, `mcpServers.<server-name>.command`, `mcpServers.<server-name>.args`, `mcpServers.<server-name>.env`, `mcpServers.<server-name>.url`, and `mcpServers.<server-name>.headers`.
...
The automation's `harness` map accepts `harness.type`, `harness.model`, `harness.reasoningLevel`, `harness.auth`, `harness.auth.source`, and `harness.auth.secretName`. Beneath each named server entry, its MCP map accepts `mcpServers.<server-name>.warpId`, `mcpServers.<server-name>.command`, `mcpServers.<server-name>.args`, `mcpServers.<server-name>.env`, `mcpServers.<server-name>.url`, and `mcpServers.<server-name>.headers`.
