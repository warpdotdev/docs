...
* [Deployment patterns](/factories/deployment-patterns/) - Choose Warp-hosted or managed self-hosted execution.
* [Managed self-hosting](/factories/self-hosting/) - Install a worker on infrastructure your team controls.
* [Execution security](/platform/execution-security/) - Review the data and network boundaries that apply to managed and unmanaged execution.
