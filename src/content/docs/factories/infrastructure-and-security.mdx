...
The diagram below maps those boundaries for self-hosted execution; factory runs follow the same data model. The [data security and boundaries](/platform/architecture/data-security-boundaries/) reference walks through each data class.
