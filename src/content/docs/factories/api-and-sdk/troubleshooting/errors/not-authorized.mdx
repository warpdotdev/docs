...
```json
{
  "type": "/factories/api-and-sdk/troubleshooting/errors/not-authorized/",
...
* [Access, Billing, and Identity](/platform/team-access-billing-and-identity/) — Permission model and identity
* [{VARS.WARP_PLATFORM_API}](/factories/api-and-sdk/) — API authentication and authorization
