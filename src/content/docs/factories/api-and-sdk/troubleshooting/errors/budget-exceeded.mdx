...
```json
{
  "type": "/factories/api-and-sdk/troubleshooting/errors/budget-exceeded/",
...
* [Access, Billing, and Identity](/platform/team-access-billing-and-identity/) — Budget configuration and billing details
