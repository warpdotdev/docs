...
```json
{
  "type": "/factories/api-and-sdk/troubleshooting/errors/agent-process-failed/",
...
* [environment_setup_failed](/factories/api-and-sdk/troubleshooting/errors/environment-setup-failed/) — Errors during environment setup
* [internal_error](/factories/api-and-sdk/troubleshooting/errors/internal-error/) — Catch-all for unexpected server-side errors
