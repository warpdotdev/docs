...
2. Correct the request parameters according to the [API documentation](/factories/api-and-sdk/).
3. Retry the request.
...
* [{VARS.API_SDK_NAME}](/factories/api-and-sdk/) — API request format and parameters
