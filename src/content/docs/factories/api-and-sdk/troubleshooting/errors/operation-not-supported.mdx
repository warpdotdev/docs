...
```json
{
  "type": "/factories/api-and-sdk/troubleshooting/errors/operation-not-supported/",
...
* [Self-hosting](/factories/self-hosting/) — Self-hosted agent configuration
* [{VARS.WARP_PLATFORM_API}](/factories/api-and-sdk/) — API reference for managing agent tasks
