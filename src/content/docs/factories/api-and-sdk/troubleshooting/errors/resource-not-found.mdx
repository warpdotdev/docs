...
```json
{
  "type": "/factories/api-and-sdk/troubleshooting/errors/resource-not-found/",
...
2. Check that the resource has not been deleted (for example, via the <a href={VARS.WEB_APP_URL}>{VARS.WEB_APP}</a> or CLI).
...
* [Environments](/platform/environments/) — Managing cloud agent environments
* [Managing Cloud Agents](/platform/managing-cloud-agents/) — Viewing and managing agent tasks
