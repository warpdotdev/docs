...
Use the {VARS.API_SDK_NAME} to start standalone cloud-agent runs, or to monitor, continue, and cancel any run after it starts. To find a factory and send it new work, use the [Factory API](/factories/factory-api/).

| API | Use it for |
| --- | --- |
| **Factory API** | Find a factory and dispatch new work to its foreman. |
| **{VARS.API_SDK_NAME}** | Start standalone cloud-agent runs, and manage factory or standalone runs after they begin. |
