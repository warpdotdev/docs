...
To route the alert through a factory's named agents and workflow instead, use the [factory API](/factories/factory-api/) to dispatch the request. This example remains useful for custom standalone cloud-agent intake.
