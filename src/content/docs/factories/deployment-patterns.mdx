...
* **[Unmanaged](/platform/unmanaged-execution/)** — You orchestrate. Invoke `oz agent run` directly from your CI, Kubernetes, or dev environment. Warp provides session tracking and observability; it does not start or stop agents.
...
For setup, decision guides, and a quickstart, start with [Self-hosting](/factories/self-hosting/).
