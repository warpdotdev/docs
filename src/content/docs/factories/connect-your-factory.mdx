...
| [Jira](./integrations/jira) | Issues assigned to a Rovo agent | The Rovo agent session | Task status and a text result |
...
* **Jira** - Starts work when a Rovo agent session begins in one of the Jira projects you selected. See the [Jira integration guide](./integrations/jira).
