...
The onboarding tools from `list_teams` through `get_connection_status` require browser sign-in or a personal API key. Agent API keys are for operating an existing factory and cannot use these setup tools.
