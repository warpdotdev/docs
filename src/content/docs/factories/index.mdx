...
* **factory** - An individual deployed instance of Warp Factories, connecting your repositories and tools to a team of agents. Distinct from Warp Factories, the product, and from the foreman, its coordinating agent.
