...
* [**Work with a factory programmatically**](/factories/factory-api/) - Discover a factory and dispatch work to it from your own code, or connect a coding agent with [Factory MCP](/factories/factory-mcp/).
