...
A dispatched run is an ordinary [cloud agent run](/platform/): retrieve it, send it follow-ups, or cancel it through the same [Agent API](/factories/api-and-sdk/) you'd use for any run.
...
See [key endpoints](/factories/api-and-sdk/#key-endpoints) for the full set of run-management operations, including cancellation.
...
* [{VARS.API_SDK_NAME}](/factories/api-and-sdk/) - Full endpoint reference, SDKs, and error codes for the underlying Agent API.
