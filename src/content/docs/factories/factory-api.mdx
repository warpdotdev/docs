...
description: >-
  Discover factories and dispatch tasks by UID with factory endpoints,
  without learning the foreman agent's internals.
sidebar:
  label: "Factory endpoints"
---
...
* [Agent & run endpoints](/factories/api-and-sdk/) - Full endpoint reference, SDKs, and error codes for the underlying Warp Platform API.
