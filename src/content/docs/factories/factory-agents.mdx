...
Automations start a chosen agent on a [schedule](/platform/triggers/scheduled-agents/) or when an event fires. They're one more way for work to enter your factory; the foreman still coordinates whatever they start. For all the ways to route work into a factory, see [connect your factory](/factories/connect-your-factory/).
