...
Create an API key in the [Oz web app](https://oz.warp.dev/settings) or in the Warp app under **Settings** > **Cloud platform** > **Oz Cloud API Keys**. See [API Keys](/reference/cli/api-keys/) for guidance on personal vs. agent keys (and the legacy team-key label) and on security best practices.
:::
