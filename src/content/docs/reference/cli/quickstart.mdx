...
In the Warp app, create an Agent API key in **Settings** > **Cloud platform** > **Oz Cloud API Keys**. Use **Default Service Account** for the same behavior as the old team API key. See [API Keys](/reference/cli/api-keys/) for guidance on Agent API keys and security best practices.
:::
