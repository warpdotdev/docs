...
Once you have a token, exchange it for cloud credentials using your provider's standard OIDC federation flow. The exchange happens between the cloud provider and your script — {VARS.WARP_AUTOMATION_PLATFORM} only issues the OIDC token.
