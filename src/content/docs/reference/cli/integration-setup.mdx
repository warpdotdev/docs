...
* **Triggers** provide the context that tells Warp _what_ to run. A trigger could be a Slack message where you tag @{VARS.WARP_AUTOMATION_PLATFORM}, or a Linear issue or comment.
