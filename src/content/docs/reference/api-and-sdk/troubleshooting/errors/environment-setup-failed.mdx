...
4. **Check MCP server configuration** — Verify MCP server startup commands and that any required dependencies or credentials are available. See [MCP Servers](/reference/cli/mcp-servers/).
...
* [MCP Servers](/reference/cli/mcp-servers/) — Configuring MCP servers
