...
<VideoEmbed url="https://www.youtube.com/watch?feature=youtu.be&v=fHQXLg9ybi4" title={`Monitoring Sentry with the ${VARS.WARP_AUTOMATION_PLATFORM} SDK demo video`} />
